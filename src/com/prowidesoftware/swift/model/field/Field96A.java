...
public class Field96A extends Field implements Serializable , BICContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field96A	*/
	@Override
	...
	*/
	public static Field96A get(final SwiftTagListBlock block) {
		...
		return (Field96A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field96A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field96A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field96A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field96A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field96A> result = new java.util.ArrayList<Field96A>(arr.length);
			for (final Field f : arr) {
				result.add((Field96A) f);
			}
			return result;
		}
