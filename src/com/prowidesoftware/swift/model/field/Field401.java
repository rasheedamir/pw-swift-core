...
public class Field401 extends Field implements Serializable  {
	...
	*/
	 ...
	 * @return the Code from component1 converted to Number or <code>null</code> if cannot be converted
	 */
	...
	/**
	 * Set the Code (component1) as Number
	 * @param component1 Number with the Code content to set
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field401	*/
	@Override
	...
	*/
	public static Field401 get(final SwiftTagListBlock block) {
		...
		return (Field401) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field401 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field401> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field401 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field401> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field401> result = new java.util.ArrayList<Field401>(arr.length);
			for (final Field f : arr) {
				result.add((Field401) f);
			}
			return result;
		}
