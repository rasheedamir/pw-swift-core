...
public class Field88A extends Field implements Serializable , BICContainer {
     ...
     */
    public static final String F_88A = "88A";
	...
	*/
	 ...
	 */
	public Field88A setComponent1(String component1) {
	 ...
	 */
	public Field88A setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field88A setComponent2(String component2) {
	 ...
	 */
	public Field88A setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field88A	*/
	@Override
	...
	*/
	public static Field88A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field88A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field88A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field88A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field88A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field88A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field88A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field88A> result = new java.util.ArrayList<Field88A>(arr.length);
			for (final Field f : arr) {
				result.add((Field88A) f);
			}
			return result;
		}
