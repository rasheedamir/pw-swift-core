...
public class Field256 extends Field implements Serializable , DateContainer, BICContainer {
	...
	*/
	...
	public Field256(String value) {
		...
		if (value != null) {
        	...
        	if (value.length() >= 11) {
				setComponent4(org.apache.commons.lang.StringUtils.substring(toparse, 5, 11));
			}
			if (value.length() >= 15) {
				setComponent5(org.apache.commons.lang.StringUtils.substring(toparse, 11, 15));
			}
			if (value.length() > 15) {
				setComponent6(org.apache.commons.lang.StringUtils.substring(toparse, 15));
			}
		}
	}
	 ...
	 */
	public Field256 setComponent1(com.prowidesoftware.swift.model.BIC component1) {
	 ...
	 */
	public Field256 setBIC(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field256 setBIC(com.prowidesoftware.swift.model.BIC component1) {
		setComponent(1, SwiftFormatUtils.getBIC(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field256	*/
	@Override
	...
	*/
	public static Field256 get(final SwiftTagListBlock block) {
		...
		return (Field256) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field256 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field256> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field256 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field256> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field256> result = new java.util.ArrayList<Field256>(arr.length);
			for (final Field f : arr) {
				result.add((Field256) f);
			}
			return result;
		}
