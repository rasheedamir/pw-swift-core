...
public class Field29J extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 29J
	 */
    public static final String NAME = "29J";
    /**
	...
	*/
	 ...
	 */
	public Field29J setComponent1(String component1) {
	 ...
	 */
	public Field29J setLocation(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field29J setComponent2(String component2) {
	 ...
	 */
	public Field29J setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field29J setTime(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field29J setTime(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getTime3(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field29J	*/
	@Override
	...
	*/
	public static Field29J get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field29J) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field29J get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field29J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field29J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field29J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field29J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field29J> result = new java.util.ArrayList<Field29J>(arr.length);
			for (final Field f : arr) {
				result.add((Field29J) f);
			}
			return result;
		}
