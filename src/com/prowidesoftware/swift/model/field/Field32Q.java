...
public class Field32Q extends Field implements Serializable , CurrencyContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32Q	*/
	@Override
	...
	*/
	public static Field32Q get(final SwiftTagListBlock block) {
		...
		return (Field32Q) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field32Q in the given message
	...
	/**
	 * Get a list of all occurrences of the field Field32Q from the given block
	 * an empty list is returned if none found.
	 *
