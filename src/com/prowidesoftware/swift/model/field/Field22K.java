...
public class Field22K extends Field implements Serializable  {
	...
	*/
	 ...
	 * @return the Type Of Event from component1
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field22K	*/
	@Override
	...
	*/
	public static Field22K get(final SwiftTagListBlock block) {
		...
		return (Field22K) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field22K in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field22K> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field22K from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field22K> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field22K> result = new java.util.ArrayList<Field22K>(arr.length);
			for (final Field f : arr) {
				result.add((Field22K) f);
			}
			return result;
		}
