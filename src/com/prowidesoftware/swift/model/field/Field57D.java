...
public class Field57D extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field57D	*/
	@Override
	...
	*/
	public static Field57D get(final SwiftTagListBlock block) {
		...
		return (Field57D) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field57D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field57D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field57D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field57D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field57D> result = new java.util.ArrayList<Field57D>(arr.length);
			for (final Field f : arr) {
				result.add((Field57D) f);
			}
			return result;
		}
