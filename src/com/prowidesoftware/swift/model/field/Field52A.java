...
public class Field52A extends Field implements Serializable , BICContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field52A	*/
	@Override
	...
	*/
	public static Field52A get(final SwiftTagListBlock block) {
		...
		return (Field52A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field52A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field52A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field52A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field52A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field52A> result = new java.util.ArrayList<Field52A>(arr.length);
			for (final Field f : arr) {
				result.add((Field52A) f);
			}
			return result;
		}
