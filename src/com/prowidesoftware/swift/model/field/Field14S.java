...
public class Field14S extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field14S	*/
	@Override
	...
	*/
	public static Field14S get(final SwiftTagListBlock block) {
		...
		return (Field14S) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field14S> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field14S> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field14S> result = new java.util.ArrayList<Field14S>(arr.length);
			for (final Field f : arr) {
				result.add((Field14S) f);
			}
			return result;
		}
