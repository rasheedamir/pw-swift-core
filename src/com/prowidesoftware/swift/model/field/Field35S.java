...
public class Field35S extends Field implements Serializable , AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 35S
	 */
    public static final String NAME = "35S";
    /**
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field35S	*/
	@Override
	...
	*/
	public static Field35S get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field35S) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field35S get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field35S in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field35S> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field35S from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field35S> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field35S> result = new java.util.ArrayList<Field35S>(arr.length);
			for (final Field f : arr) {
				result.add((Field35S) f);
			}
			return result;
		}
