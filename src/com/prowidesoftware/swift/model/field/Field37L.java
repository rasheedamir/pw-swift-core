...
public class Field37L extends Field implements Serializable , AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37L	*/
	@Override
	...
	*/
	public static Field37L get(final SwiftTagListBlock block) {
		...
		return (Field37L) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field37L in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37L> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37L from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37L> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37L> result = new java.util.ArrayList<Field37L>(arr.length);
			for (final Field f : arr) {
				result.add((Field37L) f);
			}
			return result;
		}
