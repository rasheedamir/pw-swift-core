...
public class Field272 extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 272
	 */
    public static final String NAME = "272";
    /**
	...
	*/
	 ...
	 */
	public Field272 setComponent1(String component1) {
	 ...
	 */
	public Field272 setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field272 setTimestamp(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field272 setTimestamp(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDateTimeShortYear(component1));
		return this;
	}
	 ...
	 */
	public Field272 setComponent2(String component2) {
	 ...
	 * @param component2 the Abort to set
	 */
	public Field272 setAbort(String component2) {
		setComponent(2, component2);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field272	*/
	@Override
	...
	*/
	public static Field272 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field272) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field272 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field272 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field272> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field272 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field272> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field272> result = new java.util.ArrayList<Field272>(arr.length);
			for (final Field f : arr) {
				result.add((Field272) f);
			}
			return result;
		}
