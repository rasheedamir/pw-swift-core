...
public class Field55B extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 55B
	 */
    public static final String NAME = "55B";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_55B = "55B";
	...
	*/
	 ...
	 */
	public Field55B setComponent1(String component1) {
	 ...
	 */
	public Field55B setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field55B setComponent2(String component2) {
	 ...
	 */
	public Field55B setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field55B setComponent3(String component3) {
	 ...
	 */
	public Field55B setLocation(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field55B	*/
	@Override
	...
	*/
	public static Field55B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field55B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field55B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field55B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field55B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field55B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field55B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field55B> result = new java.util.ArrayList<Field55B>(arr.length);
			for (final Field f : arr) {
				result.add((Field55B) f);
			}
			return result;
		}
