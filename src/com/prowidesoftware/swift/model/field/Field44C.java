...
public class Field44C extends Field implements Serializable , DateContainer {
	...
	*/
	 ...
	 */
	public Field44C setComponent1(String component1) {
	 ...
	 */
	public Field44C setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field44C setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field44C setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field44C	*/
	@Override
	...
	*/
	public static Field44C get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field44C) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field44C get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field44C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field44C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field44C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field44C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field44C> result = new java.util.ArrayList<Field44C>(arr.length);
			for (final Field f : arr) {
				result.add((Field44C) f);
			}
			return result;
		}
