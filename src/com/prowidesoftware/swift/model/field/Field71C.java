...
public class Field71C extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field71C	*/
	@Override
	...
	*/
	public static Field71C get(final SwiftTagListBlock block) {
		...
		return (Field71C) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field71C in the given message
	...
	/**
	 * Get a list of all occurrences of the field Field71C from the given block
	 * an empty list is returned if none found.
	 *
