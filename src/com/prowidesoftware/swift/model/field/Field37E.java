...
public class Field37E extends Field implements Serializable , DateContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37E	*/
	@Override
	...
	*/
	public static Field37E get(final SwiftTagListBlock block) {
		...
		return (Field37E) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field37E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field37E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37E> result = new java.util.ArrayList<Field37E>(arr.length);
			for (final Field f : arr) {
				result.add((Field37E) f);
			}
			return result;
		}
