...
public class Field86 extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field86 setNarrative(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field86	*/
	@Override
	...
	*/
	public static Field86 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field86) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field86 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field86 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field86> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field86 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field86> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field86> result = new java.util.ArrayList<Field86>(arr.length);
			for (final Field f : arr) {
				result.add((Field86) f);
			}
			return result;
		}
