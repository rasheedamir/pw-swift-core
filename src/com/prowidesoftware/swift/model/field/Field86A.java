...
public class Field86A extends Field implements Serializable , BICContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 86A
	 */
    public static final String NAME = "86A";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_86A = "86A";
	...
	*/
	 ...
	 */
	public Field86A setComponent1(String component1) {
	 ...
	 */
	public Field86A setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field86A setComponent2(String component2) {
	 ...
	 */
	public Field86A setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field86A setComponent3(String component3) {
	 ...
	 */
	public Field86A setComponent3(com.prowidesoftware.swift.model.BIC component3) {
	 ...
	 */
	public Field86A setBIC(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field86A setBIC(com.prowidesoftware.swift.model.BIC component3) {
		setComponent(3, SwiftFormatUtils.getBIC(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field86A	*/
	@Override
	...
	*/
	public static Field86A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field86A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field86A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field86A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field86A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field86A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field86A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field86A> result = new java.util.ArrayList<Field86A>(arr.length);
			for (final Field f : arr) {
				result.add((Field86A) f);
			}
			return result;
		}
