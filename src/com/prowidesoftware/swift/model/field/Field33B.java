...
public class Field33B extends Field implements Serializable , CurrencyContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 33B
	 */
    public static final String NAME = "33B";
    /**
	...
	*/
	 ...
	 */
	public Field33B setComponent1(String component1) {
	 ...
	 */
	public Field33B setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field33B setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field33B setCurrency(java.util.Currency component1) {
		setComponent(1, SwiftFormatUtils.getCurrency(component1));
		return this;
	}
	 ...
	 */
	public Field33B setComponent2(String component2) {
	 ...
	 */
	public Field33B setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field33B setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field33B setAmount(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33B	*/
	@Override
	...
	*/
	public static Field33B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field33B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field33B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field33B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field33B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33B> result = new java.util.ArrayList<Field33B>(arr.length);
			for (final Field f : arr) {
				result.add((Field33B) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
