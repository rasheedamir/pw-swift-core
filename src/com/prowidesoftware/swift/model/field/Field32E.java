...
public class Field32E extends Field implements Serializable , CurrencyContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32E	*/
	@Override
	...
	*/
	public static Field32E get(final SwiftTagListBlock block) {
		...
		return (Field32E) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field32E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field32E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32E> result = new java.util.ArrayList<Field32E>(arr.length);
			for (final Field f : arr) {
				result.add((Field32E) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
