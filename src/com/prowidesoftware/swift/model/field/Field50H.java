...
public class Field50H extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field50H	*/
	@Override
	...
	*/
	public static Field50H get(final SwiftTagListBlock block) {
		...
		return (Field50H) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field50H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field50H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field50H> result = new java.util.ArrayList<Field50H>(arr.length);
			for (final Field f : arr) {
				result.add((Field50H) f);
			}
			return result;
		}
