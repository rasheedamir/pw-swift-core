...
public class Field81D extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 81D
	 */
    public static final String NAME = "81D";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_81D = "81D";
	...
	*/
	 ...
	 */
	public Field81D setComponent1(String component1) {
	 ...
	 */
	public Field81D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field81D setComponent2(String component2) {
	 ...
	 */
	public Field81D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field81D setComponent3(String component3) {
	 ...
	 */
	public Field81D setComponent4(String component4) {
	 ...
	 */
	public Field81D setComponent5(String component5) {
	 ...
	 */
	public Field81D setComponent6(String component6) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field81D	*/
	@Override
	...
	*/
	public static Field81D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field81D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field81D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field81D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field81D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field81D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field81D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field81D> result = new java.util.ArrayList<Field81D>(arr.length);
			for (final Field f : arr) {
				result.add((Field81D) f);
			}
			return result;
		}
