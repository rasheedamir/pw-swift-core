...
public class Field22S extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field22S	*/
	@Override
	...
	*/
	public static Field22S get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field22S) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field22S get(final SwiftMessage msg) {
	 ...
	 */ 
	public static java.util.List<Field22S> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field22S> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field22S> result = new java.util.ArrayList<Field22S>(arr.length);
			for (final Field f : arr) {
				result.add((Field22S) f);
			}
			return result;
		}
