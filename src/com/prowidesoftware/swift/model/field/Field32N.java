...
public class Field32N extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 32N
	 */
    public static final String NAME = "32N";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_32N = "32N";
	...
	*/
	 ...
	 */
	public Field32N setComponent1(String component1) {
	 ...
	 */
	public Field32N setSign(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field32N setComponent2(String component2) {
	 ...
	 */
	public Field32N setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field32N setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field32N setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate2(component2));
		return this;
	}
	 ...
	 */
	public Field32N setComponent3(String component3) {
	 ...
	 */
	public Field32N setComponent3(java.util.Currency component3) {
	 ...
	 */
	public Field32N setCurrency(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field32N setCurrency(java.util.Currency component3) {
		setComponent(3, SwiftFormatUtils.getCurrency(component3));
		return this;
	}
	 ...
	 */
	public Field32N setComponent4(String component4) {
	 ...
	 */
	public Field32N setComponent4(java.lang.Number component4) {
	 ...
	 */
	public Field32N setAmount(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field32N setAmount(java.lang.Number component4) {
		setComponent(4, SwiftFormatUtils.getNumber(component4));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32N	*/
	@Override
	...
	*/
	public static Field32N get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32N) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field32N in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field32N get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field32N in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field32N> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field32N from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field32N> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32N> result = new java.util.ArrayList<Field32N>(arr.length);
			for (final Field f : arr) {
				result.add((Field32N) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
