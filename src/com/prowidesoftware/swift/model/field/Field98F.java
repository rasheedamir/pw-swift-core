 ...
 * Field 98F<br /><br />
 *
 * validation pattern: :4!c/[8c]/4!c&lt;TIME2&gt;<br />
 * parser pattern: :S//[S]/S&lt;TIME2&gt;<br />
 * components pattern: SSST<br />
 *
...
public class Field98F extends Field implements Serializable , GenericField {
	...
	*/
	...
	public Field98F(String value) {
		...
		if (toparse2 != null) {
			...
			setComponent3(org.apache.commons.lang.StringUtils.substring(toparse2, 0, toparse2.length()-8));
			setComponent4(org.apache.commons.lang.StringUtils.substring(toparse2, toparse2.length()-8));
		    } else {
			setComponent3(toparse2);
		    }
		}
	}
	 ...
	 */
	public Field98F setComponent4(java.util.Calendar component4) {
	 ...
	 */
	public Field98F setTime(java.util.Calendar component4) {
		setComponent(4, SwiftFormatUtils.getTime2(component4));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field98F	*/
	@Override
	...
	*/
	public static Field98F get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field98F) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field98F get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field98F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field98F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field98F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field98F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field98F> result = new java.util.ArrayList<Field98F>(arr.length);
			for (final Field f : arr) {
				result.add((Field98F) f);
			}
			return result;
		}
