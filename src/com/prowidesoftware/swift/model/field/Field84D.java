...
public class Field84D extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 84D
	 */
    public static final String NAME = "84D";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_84D = "84D";
	...
	*/
	 ...
	 */
	public Field84D setComponent1(String component1) {
	 ...
	 */
	public Field84D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field84D setComponent2(String component2) {
	 ...
	 */
	public Field84D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field84D setComponent3(String component3) {
	 ...
	 */
	public Field84D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field84D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field84D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field84D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field84D setNameAndAddress(String value) {
		java.util.List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field84D setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field84D setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	 ...
	 */
	public Field84D setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field84D	*/
	@Override
	...
	*/
	public static Field84D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field84D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field84D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field84D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field84D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field84D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field84D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field84D> result = new java.util.ArrayList<Field84D>(arr.length);
			for (final Field f : arr) {
				result.add((Field84D) f);
			}
			return result;
		}
