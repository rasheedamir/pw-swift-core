...
public class Field263 extends Field implements Serializable , DateContainer, BICContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field263	*/
	@Override
	...
	*/
	public static Field263 get(final SwiftTagListBlock block) {
		...
		return (Field263) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field263 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field263> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field263 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field263> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field263> result = new java.util.ArrayList<Field263>(arr.length);
			for (final Field f : arr) {
				result.add((Field263) f);
			}
			return result;
		}
