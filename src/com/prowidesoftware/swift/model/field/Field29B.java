...
public class Field29B extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field29B	*/
	@Override
	...
	*/
	public static Field29B get(final SwiftTagListBlock block) {
		...
		return (Field29B) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field29B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field29B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field29B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field29B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field29B> result = new java.util.ArrayList<Field29B>(arr.length);
			for (final Field f : arr) {
				result.add((Field29B) f);
			}
			return result;
		}
