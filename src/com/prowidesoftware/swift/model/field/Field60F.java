...
public class Field60F extends Field implements Serializable , DateContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field60F setComponent1(String component1) {
	 ...
	 */
	public Field60F setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field60F setComponent2(String component2) {
	 ...
	 */
	public Field60F setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field60F setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field60F setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate2(component2));
		return this;
	}
	 ...
	 */
	public Field60F setComponent3(String component3) {
	 ...
	 */
	public Field60F setComponent3(java.util.Currency component3) {
	 ...
	 */
	public Field60F setCurrency(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field60F setComponent4(String component4) {
	 ...
	 */
	public Field60F setComponent4(java.lang.Number component4) {
	 ...
	 */
	public Field60F setAmount(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field60F setAmount(java.lang.Number component4) {
		setComponent(4, SwiftFormatUtils.getNumber(component4));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field60F	*/
	@Override
	...
	*/
	public static Field60F get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field60F) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field60F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field60F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field60F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field60F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field60F> result = new java.util.ArrayList<Field60F>(arr.length);
			for (final Field f : arr) {
				result.add((Field60F) f);
			}
			return result;
		}
