...
public class Field28C extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field28C	*/
	@Override
	...
	*/
	public static Field28C get(final SwiftTagListBlock block) {
		...
		return (Field28C) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field28C in the given message
	...
	/**
	 * Get a list of all occurrences of the field Field28C from the given block
	 * an empty list is returned if none found.
	 *
