...
public class Field33V extends Field implements Serializable , CurrencyContainer, AmountContainer {
	...
	/**
	 * Constant with the field name 33V
	 */
    public static final String NAME = "33V";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_33V = "33V";
	...
	*/
	 ...
	 */
	public Field33V setComponent1(String component1) {
	 ...
	 */
	public Field33V setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field33V setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field33V setCurrency(java.util.Currency component1) {
		setComponent(1, SwiftFormatUtils.getCurrency(component1));
		return this;
	}
	 ...
	 */
	public Field33V setComponent2(String component2) {
	 ...
	 */
	public Field33V setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field33V setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field33V setAmount(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33V	*/
	@Override
	...
	*/
	public static Field33V get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field33V) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field33V in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field33V get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field33V in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field33V> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33V from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33V> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33V> result = new java.util.ArrayList<Field33V>(arr.length);
			for (final Field f : arr) {
				result.add((Field33V) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
