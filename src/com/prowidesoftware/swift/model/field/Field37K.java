 ...
 * Field 37K<br /><br />
 *
 * validation pattern: 3!a&lt;AMOUNT&gt;12<br />
...
public class Field37K extends Field implements Serializable , AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37K	*/
	@Override
	...
	*/
	public static Field37K get(final SwiftTagListBlock block) {
		...
		return (Field37K) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field37K in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37K> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37K from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37K> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37K> result = new java.util.ArrayList<Field37K>(arr.length);
			for (final Field f : arr) {
				result.add((Field37K) f);
			}
			return result;
		}
