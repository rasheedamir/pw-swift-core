...
public class Field22J extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field22J	*/
	@Override
	...
	*/
	public static Field22J get(final SwiftTagListBlock block) {
		...
		return (Field22J) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field22J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field22J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field22J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field22J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field22J> result = new java.util.ArrayList<Field22J>(arr.length);
			for (final Field f : arr) {
				result.add((Field22J) f);
			}
			return result;
		}
