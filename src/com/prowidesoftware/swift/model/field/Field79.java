...
public class Field79 extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field79	*/
	@Override
	...
	*/
	public static Field79 get(final SwiftTagListBlock block) {
		...
		return (Field79) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field79> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field79> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field79> result = new java.util.ArrayList<Field79>(arr.length);
			for (final Field f : arr) {
				result.add((Field79) f);
			}
			return result;
		}
