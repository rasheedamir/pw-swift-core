 ...
 * Field 405<br /><br />
 *
 * validation pattern: 3!c[3!n]<br />
 * parser pattern: 3!SN<br />
...
public class Field405 extends Field implements Serializable  {
	...
	*/
	...
	public Field405(String value) {
		...
		if (value != null) {
        	if (value.length() >= 3) {
				setComponent1(org.apache.commons.lang.StringUtils.substring(value, 0, 3));
			}
        	if (value.length() > 3) {
				setComponent2(org.apache.commons.lang.StringUtils.substring(value, 3));
			}
		}
	}
	 ...
	 * @return the Line Field Number from component2 converted to Number or <code>null</code> if cannot be converted
	 */
	...
	/**
	 * Set the Line Field Number (component2) as Number
	 * @param component2 Number with the Line Field Number content to set
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field405	*/
	@Override
	...
	*/
	public static Field405 get(final SwiftTagListBlock block) {
		...
		return (Field405) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field405 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field405> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field405 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field405> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field405> result = new java.util.ArrayList<Field405>(arr.length);
			for (final Field f : arr) {
				result.add((Field405) f);
			}
			return result;
		}
