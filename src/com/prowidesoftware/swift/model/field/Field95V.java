...
public class Field95V extends Field implements Serializable , GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field95V	*/
	@Override
	...
	*/
	public static Field95V get(final SwiftTagListBlock block) {
		...
		return (Field95V) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field95V> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field95V> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field95V> result = new java.util.ArrayList<Field95V>(arr.length);
			for (final Field f : arr) {
				result.add((Field95V) f);
			}
			return result;
		}
