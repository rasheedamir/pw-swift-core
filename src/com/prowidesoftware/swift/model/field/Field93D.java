...
public class Field93D extends Field implements Serializable , AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field93D	*/
	@Override
	...
	*/
	public static Field93D get(final SwiftTagListBlock block) {
		...
		return (Field93D) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field93D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field93D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field93D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field93D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field93D> result = new java.util.ArrayList<Field93D>(arr.length);
			for (final Field f : arr) {
				result.add((Field93D) f);
			}
			return result;
		}
