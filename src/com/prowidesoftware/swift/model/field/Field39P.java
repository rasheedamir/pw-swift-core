...
public class Field39P extends Field implements Serializable , CurrencyContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 39P
	 */
    public static final String NAME = "39P";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_39P = "39P";
	...
	*/
	 ...
	 */
	public Field39P setComponent1(String component1) {
	 ...
	 */
	public Field39P setComponent2(String component2) {
	 ...
	 */
	public Field39P setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field39P setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field39P setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field39P setComponent3(String component3) {
	 ...
	 */
	public Field39P setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field39P setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field39P setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field39P	*/
	@Override
	...
	*/
	public static Field39P get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field39P) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field39P in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field39P get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field39P in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field39P> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field39P from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field39P> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field39P> result = new java.util.ArrayList<Field39P>(arr.length);
			for (final Field f : arr) {
				result.add((Field39P) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
