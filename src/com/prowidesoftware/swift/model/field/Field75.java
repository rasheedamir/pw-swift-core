...
public class Field75 extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field75 setComponent2(String component2) {
	 ...
	 */
	public Field75 setComponent3(String component3) {
	 ...
	 */
	public Field75 setComponent4(String component4) {
	 ...
	 */
	public Field75 setComponent5(String component5) {
	 ...
	 */
	public Field75 setComponent6(String component6) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field75	*/
	@Override
	...
	*/
	public static Field75 get(final SwiftTagListBlock block) {
		...
		return (Field75) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field75 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field75> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field75 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field75> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field75> result = new java.util.ArrayList<Field75>(arr.length);
			for (final Field f : arr) {
				result.add((Field75) f);
			}
			return result;
		}
