...
public class Field42A extends Field implements Serializable , BICContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field42A	*/
	@Override
	...
	*/
	public static Field42A get(final SwiftTagListBlock block) {
		...
		return (Field42A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field42A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field42A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field42A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field42A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field42A> result = new java.util.ArrayList<Field42A>(arr.length);
			for (final Field f : arr) {
				result.add((Field42A) f);
			}
			return result;
		}
