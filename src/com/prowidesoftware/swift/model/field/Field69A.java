 ...
 * Field 69A<br /><br />
 *
 * validation pattern: :4!c//&lt;DATE4&gt;/&lt;DATE4&gt;<br />
 * parser pattern: :S//S/S<br />
 * components pattern: SDD<br />
 *
...
public class Field69A extends Field implements Serializable , DateContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field69A	*/
	@Override
	...
	*/
	public static Field69A get(final SwiftTagListBlock block) {
		...
		return (Field69A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field69A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field69A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field69A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field69A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field69A> result = new java.util.ArrayList<Field69A>(arr.length);
			for (final Field f : arr) {
				result.add((Field69A) f);
			}
			return result;
		}
