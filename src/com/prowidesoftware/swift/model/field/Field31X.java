...
public class Field31X extends Field implements Serializable , DateContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field31X	*/
	@Override
	...
	*/
	public static Field31X get(final SwiftTagListBlock block) {
		...
		return (Field31X) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field31X in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field31X> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field31X from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field31X> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field31X> result = new java.util.ArrayList<Field31X>(arr.length);
			for (final Field f : arr) {
				result.add((Field31X) f);
			}
			return result;
		}
