 ...
 * Field 78<br /><br />
 *
 * validation pattern: 65x[$65x]0-11<br />
 * parser pattern: S[$S]0-11<br />
 * components pattern: SSSSSSSSSSSS<br />
 *
...
public class Field78 extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field78	*/
	@Override
	...
	*/
	public static Field78 get(final SwiftTagListBlock block) {
		...
		return (Field78) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field78> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field78> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field78> result = new java.util.ArrayList<Field78>(arr.length);
			for (final Field f : arr) {
				result.add((Field78) f);
			}
			return result;
		}
