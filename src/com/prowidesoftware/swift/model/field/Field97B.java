 ...
 * Field 97B<br /><br />
 *
 * validation pattern: :4!c/[8c]/4!c/35x<br />
...
public class Field97B extends Field implements Serializable , GenericField {
	...
	*/
	 ...
	 */
	public Field97B setComponent1(String component1) {
	 ...
	 */
	public Field97B setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field97B setComponent2(String component2) {
	 ...
	 */
	public Field97B setDataSourceScheme(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field97B setComponent3(String component3) {
	 ...
	 * @param component3 the Account Type Code to set
	 */
	public Field97B setAccountTypeCode(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field97B setComponent4(String component4) {
	 ...
	 * @param component4 the Account Number to set
	 */
	public Field97B setAccountNumber(String component4) {
		setComponent(4, component4);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field97B	*/
	@Override
	...
	*/
	public static Field97B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field97B) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field97B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field97B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field97B> result = new java.util.ArrayList<Field97B>(arr.length);
			for (final Field f : arr) {
				result.add((Field97B) f);
			}
			return result;
		}
