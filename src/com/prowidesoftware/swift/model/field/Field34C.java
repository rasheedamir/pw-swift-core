...
public class Field34C extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field34C setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field34C setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field34C setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field34C setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field34C setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field34C setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field34C setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field34C setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field34C setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field34C	*/
	@Override
	...
	*/
	public static Field34C get(final SwiftTagListBlock block) {
		...
		return (Field34C) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field34C in the given message.
	...
	/**
	 * Get a list of all occurrences of the field Field34C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field34C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field34C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field34C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field34C> result = new java.util.ArrayList<Field34C>(arr.length);
			for (final Field f : arr) {
				result.add((Field34C) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
