 ...
 * Field 98A<br /><br />
 *
 * validation pattern: :4!c//&lt;DATE4&gt;<br />
 * parser pattern: :S//&lt;DATE4&gt;<br />
 * components pattern: SD<br />
 *
...
public class Field98A extends Field implements Serializable , DateContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field98A	*/
	@Override
	...
	*/
	public static Field98A get(final SwiftTagListBlock block) {
		...
		return (Field98A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field98A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field98A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field98A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field98A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field98A> result = new java.util.ArrayList<Field98A>(arr.length);
			for (final Field f : arr) {
				result.add((Field98A) f);
			}
			return result;
		}
