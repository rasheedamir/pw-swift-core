 ...
 * Field 60B<br /><br />
 *
 * validation pattern: &lt;DC&gt;&lt;DATE2&gt;&lt;3!a&gt;&lt;AMOUNT&gt;15<br />
 * parser pattern: [c]&lt;DATE2&gt;SN<br />
 * components pattern: SESN<br />
 *
...
public class Field60B extends Field implements Serializable , DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 60B
	 */
    public static final String NAME = "60B";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_60B = "60B";
	...
	*/
	 ...
	 */
	public Field60B setComponent1(String component1) {
	 ...
	 */
	public Field60B setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field60B setComponent2(String component2) {
	 ...
	 */
	public Field60B setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field60B setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field60B setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate2(component2));
		return this;
	}
	 ...
	 */
	public Field60B setComponent3(String component3) {
	 ...
	 */
	public Field60B setCurrency(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field60B setComponent4(String component4) {
	 ...
	 */
	public Field60B setComponent4(java.lang.Number component4) {
	 ...
	 */
	public Field60B setAmount(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field60B setAmount(java.lang.Number component4) {
		setComponent(4, SwiftFormatUtils.getNumber(component4));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field60B	*/
	@Override
	...
	*/
	public static Field60B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field60B) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field60B in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field60B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field60B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field60B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field60B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field60B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field60B> result = new java.util.ArrayList<Field60B>(arr.length);
			for (final Field f : arr) {
				result.add((Field60B) f);
			}
			return result;
		}
