...
public class Field74 extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 74
	 */
    public static final String NAME = "74";
    /**
	...
	*/
	 ...
	 */
	public Field74 setComponent1(String component1) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field74	*/
	@Override
	...
	*/
	public static Field74 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field74) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field74 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field74 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field74> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field74 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field74> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field74> result = new java.util.ArrayList<Field74>(arr.length);
			for (final Field f : arr) {
				result.add((Field74) f);
			}
			return result;
		}
