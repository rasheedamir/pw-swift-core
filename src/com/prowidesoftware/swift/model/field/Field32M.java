...
public class Field32M extends Field implements Serializable , CurrencyContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 32M
	 */
    public static final String NAME = "32M";
    /**
	...
	*/
	 ...
	 */
	public Field32M setComponent1(String component1) {
	 ...
	 */
	public Field32M setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field32M setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field32M setCurrency(java.util.Currency component1) {
		setComponent(1, SwiftFormatUtils.getCurrency(component1));
		return this;
	}
	 ...
	 */
	public Field32M setComponent2(String component2) {
	 ...
	 */
	public Field32M setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field32M setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field32M setAmount(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32M	*/
	@Override
	...
	*/
	public static Field32M get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32M) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field32M get(final SwiftMessage msg) {
	 ...
	 */ 
	public static java.util.List<Field32M> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field32M> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32M> result = new java.util.ArrayList<Field32M>(arr.length);
			for (final Field f : arr) {
				result.add((Field32M) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
