...
public class Field92N extends Field implements Serializable , CurrencyContainer, AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field92N	*/
	@Override
	...
	*/
	public static Field92N get(final SwiftTagListBlock block) {
		...
		return (Field92N) block.getFieldByName(NAME);
	}
