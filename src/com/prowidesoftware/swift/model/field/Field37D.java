...
public class Field37D extends Field implements Serializable , DateContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field37D setComponent1(java.lang.Number component1) {
	 ...
	 */
	public Field37D setRate(java.lang.Number component1) {
		setComponent(1, SwiftFormatUtils.getNumber(component1));
		return this;
	}
	 ...
	 */
	public Field37D setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field37D setComponent4(java.lang.Number component4) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37D	*/
	@Override
	...
	*/
	public static Field37D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field37D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field37D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field37D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37D> result = new java.util.ArrayList<Field37D>(arr.length);
			for (final Field f : arr) {
				result.add((Field37D) f);
			}
			return result;
		}
