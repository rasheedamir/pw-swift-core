...
public class Field28E extends Field implements Serializable  {
	...
	*/
	...
	/**
	 * Set the Page Number (component1) as Number
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field28E	*/
	@Override
	...
	*/
	public static Field28E get(final SwiftTagListBlock block) {
		...
		return (Field28E) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field28E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field28E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field28E> result = new java.util.ArrayList<Field28E>(arr.length);
			for (final Field f : arr) {
				result.add((Field28E) f);
			}
			return result;
		}
