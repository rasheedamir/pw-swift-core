...
public class Field31J extends Field implements Serializable , DateContainer {
	...
	/**
	 * Constant with the field name 31J
	 */
    public static final String NAME = "31J";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_31J = "31J";
	...
	*/
	 ...
	 */
	public Field31J setComponent1(String component1) {
	 ...
	 */
	public Field31J setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field31J setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field31J setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field31J setComponent2(String component2) {
	 ...
	 */
	public Field31J setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field31J setTime(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field31J setTime(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getTime3(component2));
		return this;
	}
	 ...
	 */
	public Field31J setComponent3(String component3) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field31J	*/
	@Override
	...
	*/
	public static Field31J get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field31J) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field31J in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field31J get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field31J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field31J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field31J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field31J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field31J> result = new java.util.ArrayList<Field31J>(arr.length);
			for (final Field f : arr) {
				result.add((Field31J) f);
			}
			return result;
		}
