...
public class Field85B extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field85B setComponent1(String component1) {
	 ...
	 */
	public Field85B setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field85B setComponent2(String component2) {
	 ...
	 */
	public Field85B setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field85B setComponent3(String component3) {
	 ...
	 */
	public Field85B setLocation(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field85B	*/
	@Override
	...
	*/
	public static Field85B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field85B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field85B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field85B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field85B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field85B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field85B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field85B> result = new java.util.ArrayList<Field85B>(arr.length);
			for (final Field f : arr) {
				result.add((Field85B) f);
			}
			return result;
		}
