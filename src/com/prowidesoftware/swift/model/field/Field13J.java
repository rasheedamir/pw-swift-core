...
public class Field13J extends Field implements Serializable , GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field13J	*/
	@Override
	...
	*/
	public static Field13J get(final SwiftTagListBlock block) {
		...
		return (Field13J) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field13J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field13J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field13J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field13J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field13J> result = new java.util.ArrayList<Field13J>(arr.length);
			for (final Field f : arr) {
				result.add((Field13J) f);
			}
			return result;
		}
