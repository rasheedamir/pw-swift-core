...
public class Field33T extends Field implements Serializable , AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 33T
	 */
    public static final String NAME = "33T";
    /**
	...
	*/
	 ...
	 */
	public Field33T setComponent1(String component1) {
	 ...
	 */
	public Field33T setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field33T setComponent2(String component2) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33T	*/
	@Override
	...
	*/
	public static Field33T get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field33T) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field33T get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field33T in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field33T> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33T from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33T> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33T> result = new java.util.ArrayList<Field33T>(arr.length);
			for (final Field f : arr) {
				result.add((Field33T) f);
			}
			return result;
		}
