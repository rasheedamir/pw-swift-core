...
public class Field37N extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field37N setComponent2(String component2) {
	 ...
	 */
	public Field37N setComponent3(String component3) {
	 ...
	 */
	public Field37N setComponent4(String component4) {
	 ...
	 */
	public Field37N setComponent5(String component5) {
	 ...
	 */
	public Field37N setComponent6(String component6) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37N	*/
	@Override
	...
	*/
	public static Field37N get(final SwiftTagListBlock block) {
		...
		return (Field37N) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field37N in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37N> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37N from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37N> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37N> result = new java.util.ArrayList<Field37N>(arr.length);
			for (final Field f : arr) {
				result.add((Field37N) f);
			}
			return result;
		}
