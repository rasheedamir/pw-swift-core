...
public class Field37C extends Field implements Serializable , DateContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field37C setComponent1(java.lang.Number component1) {
	 ...
	 */
	public Field37C setRate(java.lang.Number component1) {
		setComponent(1, SwiftFormatUtils.getNumber(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37C	*/
	@Override
	...
	*/
	public static Field37C get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field37C) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field37C get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field37C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37C> result = new java.util.ArrayList<Field37C>(arr.length);
			for (final Field f : arr) {
				result.add((Field37C) f);
			}
			return result;
		}
