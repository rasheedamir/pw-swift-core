 ...
 * Field 11A<br /><br />
 *
 * validation pattern: :4!c//&lt;CUR&gt;<br />
 * parser pattern: :S//S<br />
 * components pattern: SC<br />
 *
...
public class Field11A extends Field implements Serializable , CurrencyContainer, GenericField {
	...
	*/
	 ...
	 */
	public Field11A setComponent2(java.util.Currency component2) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field11A	*/
	@Override
	...
	*/
	public static Field11A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field11A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field11A get(final SwiftMessage msg) {
	 ...
	 */ 
	public static java.util.List<Field11A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field11A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field11A> result = new java.util.ArrayList<Field11A>(arr.length);
			for (final Field f : arr) {
				result.add((Field11A) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
