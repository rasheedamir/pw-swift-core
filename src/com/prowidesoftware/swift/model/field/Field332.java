 ...
 * Field 332<br /><br />
 *
 * validation pattern: 6!n6!n<br />
 * parser pattern: 6!N6!N<br />
...
public class Field332 extends Field implements Serializable  {
	...
	*/
	...
	public Field332(String value) {
		...
		if (value != null) {
        	...
        	if (value.length() > 6) {
				setComponent2(org.apache.commons.lang.StringUtils.substring(value, 6));
			}
		}
	}
	 ...
	 * @return the Total Messages Sent from component1 converted to Number or <code>null</code> if cannot be converted
	 */
	 ...
	 * @param component1 the Total Messages Sent to set
	 */
	...
	/**
	 * Set the Total Messages Sent (component1) as Number
	 * @param component1 Number with the Total Messages Sent content to set
	 */
	public Field332 setTotalMessagesSent(java.lang.Number component1) {
		setComponent(1, SwiftFormatUtils.getNumber(component1));
		return this;
	}
	 ...
	 * @return the Total Messages Received from component2 converted to Number or <code>null</code> if cannot be converted
	 */
	 ...
	 * @param component2 the Total Messages Received to set
	 */
	...
	/**
	 * Set the Total Messages Received (component2) as Number
	 * @param component2 Number with the Total Messages Received content to set
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field332	*/
	@Override
	...
	*/
	public static Field332 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field332) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field332 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field332 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field332> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field332 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field332> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field332> result = new java.util.ArrayList<Field332>(arr.length);
			for (final Field f : arr) {
				result.add((Field332) f);
			}
			return result;
		}
