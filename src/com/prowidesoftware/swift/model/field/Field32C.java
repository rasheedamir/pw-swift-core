...
public class Field32C extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 32C
	 */
    public static final String NAME = "32C";
    /**
	...
	*/
	 ...
	 */
	public Field32C setComponent1(String component1) {
	 ...
	 */
	public Field32C setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field32C setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field32C setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field32C setComponent2(String component2) {
	 ...
	 */
	public Field32C setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field32C setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field32C setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field32C setComponent3(String component3) {
	 ...
	 */
	public Field32C setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field32C setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field32C setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32C	*/
	@Override
	...
	*/
	public static Field32C get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32C) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field32C get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field32C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field32C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field32C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field32C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32C> result = new java.util.ArrayList<Field32C>(arr.length);
			for (final Field f : arr) {
				result.add((Field32C) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
