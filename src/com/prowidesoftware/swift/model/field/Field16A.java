...
public class Field16A extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 16A
	 */
    public static final String NAME = "16A";
    /**
	...
	*/
	 ...
	 */
	public Field16A setComponent1(String component1) {
	 ...
	 */
	public Field16A setNumber(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field16A	*/
	@Override
	...
	*/
	public static Field16A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field16A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field16A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field16A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field16A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field16A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field16A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field16A> result = new java.util.ArrayList<Field16A>(arr.length);
			for (final Field f : arr) {
				result.add((Field16A) f);
			}
			return result;
		}
