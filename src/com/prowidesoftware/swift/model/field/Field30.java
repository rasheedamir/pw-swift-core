...
public class Field30 extends Field implements Serializable , DateContainer {
	...
	*/
	 ...
	 */
	public Field30 setComponent1(String component1) {
	 ...
	 */
	public Field30 setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field30 setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field30 setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field30	*/
	@Override
	...
	*/
	public static Field30 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field30) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field30 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field30 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field30> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field30 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field30> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field30> result = new java.util.ArrayList<Field30>(arr.length);
			for (final Field f : arr) {
				result.add((Field30) f);
			}
			return result;
		}
