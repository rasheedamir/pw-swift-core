...
public class Field31C extends Field implements Serializable , DateContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 31C
	 */
    public static final String NAME = "31C";
    /**
	...
	*/
	 ...
	 */
	public Field31C setComponent1(String component1) {
	 ...
	 */
	public Field31C setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field31C setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field31C setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field31C	*/
	@Override
	...
	*/
	public static Field31C get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field31C) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field31C get(final SwiftMessage msg) {
	 ...
	 */ 
	public static java.util.List<Field31C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field31C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field31C> result = new java.util.ArrayList<Field31C>(arr.length);
			for (final Field f : arr) {
				result.add((Field31C) f);
			}
			return result;
		}
