...
public class Field34A extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field34A setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field34A setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field34A setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field34A setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field34A setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field34A setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field34A	*/
	@Override
	...
	*/
	public static Field34A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field34A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field34A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field34A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field34A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field34A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field34A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field34A> result = new java.util.ArrayList<Field34A>(arr.length);
			for (final Field f : arr) {
				result.add((Field34A) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
