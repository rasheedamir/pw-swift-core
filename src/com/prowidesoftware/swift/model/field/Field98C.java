 ...
 * Field 98C<br /><br />
 *
 * validation pattern: :4!c//&lt;DATE4&gt;&lt;TIME2&gt;<br />
 * parser pattern: :S//&lt;DATE4&gt;&lt;TIME2&gt;<br />
 * components pattern: SDT<br />
 *
...
public class Field98C extends Field implements Serializable , DateContainer, GenericField {
	...
	*/
	...
	public Field98C(String value) {
		...
		if (toparse != null) {
			...
			if (toparse.length() > 8) {
				setComponent3(org.apache.commons.lang.StringUtils.substring(toparse, 8));
			}
		}
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field98C	*/
	@Override
	...
	*/
	public static Field98C get(final SwiftTagListBlock block) {
		...
		return (Field98C) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field98C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field98C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field98C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field98C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field98C> result = new java.util.ArrayList<Field98C>(arr.length);
			for (final Field f : arr) {
				result.add((Field98C) f);
			}
			return result;
		}
