 ...
 * Field 255<br /><br />
 *
 * validation pattern: &lt;SWIFTBIC&gt;|&lt;NON-SWIFTBIC&gt;4!n3!n&lt;DATE2&gt;[&lt;HHMM&gt;&lt;HHMM&gt;]<br />
...
public class Field255 extends Field implements Serializable , DateContainer, BICContainer {
	...
	*/
	...
	/**
	 * Set the Message Type (component3) as Number
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field255	*/
	@Override
	...
	*/
	public static Field255 get(final SwiftTagListBlock block) {
		...
		return (Field255) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field255> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field255> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field255> result = new java.util.ArrayList<Field255>(arr.length);
			for (final Field f : arr) {
				result.add((Field255) f);
			}
			return result;
		}
