 ...
 * Field 92M<br /><br />
 *
 * validation pattern: :4!c//&lt;CUR&gt;&lt;AMOUNT&gt;15/&lt;AMOUNT&gt;15<br />
 * parser pattern: :S//SN/N<br />
 * components pattern: SCNN<br />
 *
...
public class Field92M extends Field implements Serializable , CurrencyContainer, AmountContainer, GenericField {
	...
	public static final String PARSER_PATTERN =":S//SN/N";
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field92M	*/
	@Override
	...
	*/
	public static Field92M get(final SwiftTagListBlock block) {
		...
		return (Field92M) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field92M> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field92M> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field92M> result = new java.util.ArrayList<Field92M>(arr.length);
			for (final Field f : arr) {
				result.add((Field92M) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
