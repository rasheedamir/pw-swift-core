...
public class Field87D extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 87D
	 */
    public static final String NAME = "87D";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_87D = "87D";
	...
	*/
	 ...
	 */
	public Field87D setComponent1(String component1) {
	 ...
	 */
	public Field87D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field87D setComponent2(String component2) {
	 ...
	 */
	public Field87D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field87D setComponent3(String component3) {
	 ...
	 */
	public Field87D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field87D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field87D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field87D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field87D setNameAndAddress(String value) {
		java.util.List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field87D setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field87D setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	 ...
	 */
	public Field87D setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field87D	*/
	@Override
	...
	*/
	public static Field87D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field87D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field87D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field87D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field87D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field87D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field87D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field87D> result = new java.util.ArrayList<Field87D>(arr.length);
			for (final Field f : arr) {
				result.add((Field87D) f);
			}
			return result;
		}
