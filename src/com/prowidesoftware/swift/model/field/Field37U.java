...
public class Field37U extends Field implements Serializable , AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37U	*/
	@Override
	...
	*/
	public static Field37U get(final SwiftTagListBlock block) {
		...
		return (Field37U) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field37U in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37U> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37U from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37U> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37U> result = new java.util.ArrayList<Field37U>(arr.length);
			for (final Field f : arr) {
				result.add((Field37U) f);
			}
			return result;
		}
