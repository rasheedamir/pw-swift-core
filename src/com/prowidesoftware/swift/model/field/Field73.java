...
public class Field73 extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field73 setComponent2(String component2) {
	 ...
	 */
	public Field73 setComponent3(String component3) {
	 ...
	 */
	public Field73 setComponent4(String component4) {
	 ...
	 */
	public Field73 setComponent5(String component5) {
	 ...
	 */
	public Field73 setComponent6(String component6) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field73	*/
	@Override
	...
	*/
	public static Field73 get(final SwiftTagListBlock block) {
		...
		return (Field73) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field73 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field73> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field73 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field73> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field73> result = new java.util.ArrayList<Field73>(arr.length);
			for (final Field f : arr) {
				result.add((Field73) f);
			}
			return result;
		}
