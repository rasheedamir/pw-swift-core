...
public class Field257 extends Field implements Serializable , DateContainer, BICContainer {
	...
	*/
	 ...
	 */
	public Field257 setComponent1(com.prowidesoftware.swift.model.BIC component1) {
	 ...
	 */
	public Field257 setBIC(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field257 setBIC(com.prowidesoftware.swift.model.BIC component1) {
		setComponent(1, SwiftFormatUtils.getBIC(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field257	*/
	@Override
	...
	*/
	public static Field257 get(final SwiftTagListBlock block) {
		...
		return (Field257) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field257 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field257> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field257 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field257> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field257> result = new java.util.ArrayList<Field257>(arr.length);
			for (final Field f : arr) {
				result.add((Field257) f);
			}
			return result;
		}
