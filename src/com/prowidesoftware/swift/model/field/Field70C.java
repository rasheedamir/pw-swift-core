 ...
 * Field 70C<br /><br />
 *
 * validation pattern: :4!c//35x[$35x]0-3<br />
...
public class Field70C extends Field implements Serializable , GenericField {
	...
	*/
	...
	public Field70C(String value) {
		...
		SwiftParseUtils.setComponentsFromLines(this, 3, 3, 1, lines);
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field70C	*/
	@Override
	...
	*/
	public static Field70C get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field70C) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field70C get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field70C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field70C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field70C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field70C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field70C> result = new java.util.ArrayList<Field70C>(arr.length);
			for (final Field f : arr) {
				result.add((Field70C) f);
			}
			return result;
		}
