...
public class Field71J extends Field implements Serializable , CurrencyContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 71J
	 */
    public static final String NAME = "71J";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_71J = "71J";
	...
	*/
	 ...
	 */
	public Field71J setComponent1(String component1) {
	 ...
	 */
	public Field71J setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field71J setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field71J setCurrency(java.util.Currency component1) {
		setComponent(1, SwiftFormatUtils.getCurrency(component1));
		return this;
	}
	 ...
	 */
	public Field71J setComponent2(String component2) {
	 ...
	 */
	public Field71J setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field71J setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field71J setAmount(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field71J	*/
	@Override
	...
	*/
	public static Field71J get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field71J) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field71J in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field71J get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field71J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field71J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field71J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field71J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field71J> result = new java.util.ArrayList<Field71J>(arr.length);
			for (final Field f : arr) {
				result.add((Field71J) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
