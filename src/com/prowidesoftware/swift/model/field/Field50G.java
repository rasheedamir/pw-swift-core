...
public class Field50G extends Field implements Serializable , BICContainer {
	...
	*/
	 ...
	 */
	public Field50G setComponent2(com.prowidesoftware.swift.model.BIC component2) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field50G	*/
	@Override
	...
	*/
	public static Field50G get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field50G) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field50G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field50G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field50G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field50G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field50G> result = new java.util.ArrayList<Field50G>(arr.length);
			for (final Field f : arr) {
				result.add((Field50G) f);
			}
			return result;
		}
