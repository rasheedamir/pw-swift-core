...
public class Field19B extends Field implements Serializable , CurrencyContainer, AmountContainer, GenericField {
	...
	*/
	 ...
	 */
	public Field19B setComponent1(String component1) {
	 ...
	 */
	public Field19B setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field19B setComponent2(String component2) {
	 ...
	 */
	public Field19B setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field19B setComponent3(String component3) {
	 ...
	 */
	public Field19B setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field19B setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field19B setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field19B	*/
	@Override
	...
	*/
	public static Field19B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field19B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field19B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field19B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field19B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field19B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field19B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field19B> result = new java.util.ArrayList<Field19B>(arr.length);
			for (final Field f : arr) {
				result.add((Field19B) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
