...
public class Field34D extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field34D setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field34D setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field34D setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field34D setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field34D setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field34D setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field34D setComponent3(String component3) {
	 ...
	 */
	public Field34D setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field34D setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field34D setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field34D	*/
	@Override
	...
	*/
	public static Field34D get(final SwiftTagListBlock block) {
		...
		return (Field34D) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field34D in the given message.
	...
	/**
	 * Get a list of all occurrences of the field Field34D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field34D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field34D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field34D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field34D> result = new java.util.ArrayList<Field34D>(arr.length);
			for (final Field f : arr) {
				result.add((Field34D) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
