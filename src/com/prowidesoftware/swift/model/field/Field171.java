...
public class Field171 extends Field implements Serializable , DateContainer {
	 ...
	 */
    public static final String NAME = "171";
    /**
	...
	*/
	 ...
	 */
	public Field171 setComponent1(String component1) {
	 ...
	 */
	public Field171 setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field171 setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field171 setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field171	*/
	@Override
	...
	*/
	public static Field171 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field171) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field171 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field171 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field171> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field171 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field171> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field171> result = new java.util.ArrayList<Field171>(arr.length);
			for (final Field f : arr) {
				result.add((Field171) f);
			}
			return result;
		}
