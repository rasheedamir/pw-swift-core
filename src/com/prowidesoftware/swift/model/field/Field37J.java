...
public class Field37J extends Field implements Serializable , AmountContainer {
	...
	*/
	 ...
	 */
	public Field37J setComponent1(java.lang.Number component1) {
	 ...
	 */
	public Field37J setRate(java.lang.Number component1) {
		setComponent(1, SwiftFormatUtils.getNumber(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37J	*/
	@Override
	...
	*/
	public static Field37J get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field37J) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field37J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37J> result = new java.util.ArrayList<Field37J>(arr.length);
			for (final Field f : arr) {
				result.add((Field37J) f);
			}
			return result;
		}
