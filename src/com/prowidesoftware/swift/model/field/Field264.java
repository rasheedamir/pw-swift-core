...
public class Field264 extends Field implements Serializable , DateContainer, BICContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 264
	 */
    public static final String NAME = "264";
    /**
	...
	*/
	 ...
	 */
	public Field264 setComponent1(String component1) {
	 ...
	 */
	public Field264 setComponent1(com.prowidesoftware.swift.model.BIC component1) {
	 ...
	 */
	public Field264 setBIC(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field264 setBIC(com.prowidesoftware.swift.model.BIC component1) {
		setComponent(1, SwiftFormatUtils.getBIC(component1));
		return this;
	}
	 ...
	 */
	public Field264 setComponent2(String component2) {
	 ...
	 */
	public Field264 setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field264 setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field264 setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate2(component2));
		return this;
	}
	 ...
	 */
	public Field264 setComponent3(String component3) {
	 ...
	 */
	public Field264 setComponent3(java.util.Calendar component3) {
	 ...
	 */
	public Field264 setStartTime(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field264 setStartTime(java.util.Calendar component3) {
		setComponent(3, SwiftFormatUtils.getTime3(component3));
		return this;
	}
	 ...
	 */
	public Field264 setComponent4(String component4) {
	 ...
	 */
	public Field264 setComponent4(java.util.Calendar component4) {
	 ...
	 */
	public Field264 setEndTime(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field264 setEndTime(java.util.Calendar component4) {
		setComponent(4, SwiftFormatUtils.getTime3(component4));
		return this;
	}
	 ...
	 */
	public Field264 setComponent5(String component5) {
	 ...
	 */
	public Field264 setSessionNumber(String component5) {
		setComponent(5, component5);
		return this;
	}
	 ...
	 */
	public Field264 setSessionNumber(java.lang.Number component5) {
		setComponent(5, SwiftFormatUtils.getNumber(component5));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field264	*/
	@Override
	...
	*/
	public static Field264 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field264) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field264 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field264 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field264> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field264 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field264> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field264> result = new java.util.ArrayList<Field264>(arr.length);
			for (final Field f : arr) {
				result.add((Field264) f);
			}
			return result;
		}
