 ...
 * Field 31D<br /><br />
 *
 * validation pattern: &lt;DATE2&gt;29x<br />
 * parser pattern: &lt;DATE2&gt;S<br />
 * components pattern: ES<br />
 *
...
public class Field31D extends Field implements Serializable , DateContainer {
	...
	*/
	 ...
	 */
	public Field31D setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field31D setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field31D	*/
	@Override
	...
	*/
	public static Field31D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field31D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field31D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field31D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field31D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field31D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field31D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field31D> result = new java.util.ArrayList<Field31D>(arr.length);
			for (final Field f : arr) {
				result.add((Field31D) f);
			}
			return result;
		}
