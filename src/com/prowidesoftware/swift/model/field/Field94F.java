 ...
 * Field 94F<br /><br />
 *
 * validation pattern: :4!c//4!c/&lt;SWIFTBIC&gt;|&lt;NONSWIFTBIC&gt;<br />
...
public class Field94F extends Field implements Serializable , BICContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field94F	*/
	@Override
	...
	*/
	public static Field94F get(final SwiftTagListBlock block) {
		...
		return (Field94F) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field94F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field94F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field94F> result = new java.util.ArrayList<Field94F>(arr.length);
			for (final Field f : arr) {
				result.add((Field94F) f);
			}
			return result;
		}
