...
public class Field31R extends Field implements Serializable , DateContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field31R	*/
	@Override
	...
	*/
	public static Field31R get(final SwiftTagListBlock block) {
		...
		return (Field31R) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field31R in the given message.
	...
	/**
	 * Get a list of all occurrences of the field Field31R in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field31R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field31R from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field31R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field31R> result = new java.util.ArrayList<Field31R>(arr.length);
			for (final Field f : arr) {
				result.add((Field31R) f);
			}
			return result;
		}
