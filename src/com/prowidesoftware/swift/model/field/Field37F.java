...
public class Field37F extends Field implements Serializable , DateContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field37F setComponent1(String component1) {
	 ...
	 */
	public Field37F setRate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field37F setComponent2(String component2) {
	 ...
	 */
	public Field37F setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field37F setComponent3(String component3) {
	 ...
	 */
	public Field37F setComponent4(String component4) {
	 ...
	 */
	public Field37F setComponent5(String component5) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37F	*/
	@Override
	...
	*/
	public static Field37F get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field37F) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field37F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37F> result = new java.util.ArrayList<Field37F>(arr.length);
			for (final Field f : arr) {
				result.add((Field37F) f);
			}
			return result;
		}
