...
public class Field42D extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 42D
	 */
    public static final String NAME = "42D";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_42D = "42D";
	...
	*/
	 ...
	 */
	public Field42D setComponent1(String component1) {
	 ...
	 */
	public Field42D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field42D setComponent2(String component2) {
	 ...
	 */
	public Field42D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field42D setComponent3(String component3) {
	 ...
	 */
	public Field42D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field42D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field42D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field42D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field42D setNameAndAddress(String value) {
		java.util.List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field42D setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field42D setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	 ...
	 */
	public Field42D setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field42D	*/
	@Override
	...
	*/
	public static Field42D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field42D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field42D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field42D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field42D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field42D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field42D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field42D> result = new java.util.ArrayList<Field42D>(arr.length);
			for (final Field f : arr) {
				result.add((Field42D) f);
			}
			return result;
		}
