...
public class Field39A extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field39A	*/
	@Override
	...
	*/
	public static Field39A get(final SwiftTagListBlock block) {
		...
		return (Field39A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field39A in the given message
	...
	/**
	 * Get a list of all occurrences of the field Field39A from the given block
	 * an empty list is returned if none found.
	 *
