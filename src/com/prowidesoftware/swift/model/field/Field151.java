...
public class Field151 extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 151
	 */
    public static final String NAME = "151";
    /**
	...
	*/
	 ...
	 */
	public Field151 setComponent1(String component1) {
	 ...
	 */
	public Field151 setSessionNumber(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field151	*/
	@Override
	...
	*/
	public static Field151 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field151) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field151 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field151 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field151> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field151 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field151> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field151> result = new java.util.ArrayList<Field151>(arr.length);
			for (final Field f : arr) {
				result.add((Field151) f);
			}
			return result;
		}
