...
public class Field58B extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 58B
	 */
    public static final String NAME = "58B";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_58B = "58B";
	...
	*/
	 ...
	 */
	public Field58B setComponent1(String component1) {
	 ...
	 */
	public Field58B setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field58B setComponent2(String component2) {
	 ...
	 */
	public Field58B setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field58B setComponent3(String component3) {
	 ...
	 */
	public Field58B setLocation(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field58B	*/
	@Override
	...
	*/
	public static Field58B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field58B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field58B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field58B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field58B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field58B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field58B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field58B> result = new java.util.ArrayList<Field58B>(arr.length);
			for (final Field f : arr) {
				result.add((Field58B) f);
			}
			return result;
		}
