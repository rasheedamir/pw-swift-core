...
public class Field85D extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 85D
	 */
    public static final String NAME = "85D";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_85D = "85D";
	...
	*/
	 ...
	 */
	public Field85D setComponent1(String component1) {
	 ...
	 */
	public Field85D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field85D setComponent2(String component2) {
	 ...
	 */
	public Field85D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field85D setComponent3(String component3) {
	 ...
	 */
	public Field85D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field85D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field85D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field85D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field85D setNameAndAddress(String value) {
		java.util.List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field85D setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field85D setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	 ...
	 */
	public Field85D setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field85D	*/
	@Override
	...
	*/
	public static Field85D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field85D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field85D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field85D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field85D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field85D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field85D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field85D> result = new java.util.ArrayList<Field85D>(arr.length);
			for (final Field f : arr) {
				result.add((Field85D) f);
			}
			return result;
		}
