 ...
 * Field 35E<br /><br />
 *
 * validation pattern: 50x[$50x]0-5<br />
...
public class Field35E extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field35E	*/
	@Override
	...
	*/
	public static Field35E get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field35E) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field35E get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field35E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field35E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field35E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field35E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field35E> result = new java.util.ArrayList<Field35E>(arr.length);
			for (final Field f : arr) {
				result.add((Field35E) f);
			}
			return result;
		}
