...
public class Field35N extends Field implements Serializable , AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field35N	*/
	@Override
	...
	*/
	public static Field35N get(final SwiftTagListBlock block) {
		...
		return (Field35N) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field35N in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field35N> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field35N from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field35N> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field35N> result = new java.util.ArrayList<Field35N>(arr.length);
			for (final Field f : arr) {
				result.add((Field35N) f);
			}
			return result;
		}
