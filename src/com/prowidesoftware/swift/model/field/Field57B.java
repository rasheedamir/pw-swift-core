...
public class Field57B extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 57B
	 */
    public static final String NAME = "57B";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_57B = "57B";
	...
	*/
	 ...
	 */
	public Field57B setComponent1(String component1) {
	 ...
	 */
	public Field57B setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field57B setComponent2(String component2) {
	 ...
	 */
	public Field57B setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field57B setComponent3(String component3) {
	 ...
	 */
	public Field57B setLocation(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field57B	*/
	@Override
	...
	*/
	public static Field57B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field57B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field57B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field57B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field57B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field57B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field57B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field57B> result = new java.util.ArrayList<Field57B>(arr.length);
			for (final Field f : arr) {
				result.add((Field57B) f);
			}
			return result;
		}
