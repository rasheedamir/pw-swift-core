...
public class Field95Q extends Field implements Serializable , GenericField {
	...
	*/
	 ...
	 */
	public Field95Q setNameAndAddress(String component2) {
		setComponent(2, component2);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field95Q	*/
	@Override
	...
	*/
	public static Field95Q get(final SwiftTagListBlock block) {
		...
		return (Field95Q) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field95Q in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field95Q> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field95Q from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field95Q> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field95Q> result = new java.util.ArrayList<Field95Q>(arr.length);
			for (final Field f : arr) {
				result.add((Field95Q) f);
			}
			return result;
		}
