 ...
 * Field 90F<br /><br />
 *
 * validation pattern: :4!c//4!c/&lt;CUR&gt;&lt;AMOUNT&gt;15/4!c/&lt;AMOUNT&gt;15<br />
 * parser pattern: :S//S/SN/S/N<br />
 * components pattern: SSCNSN<br />
 *
...
public class Field90F extends Field implements Serializable , CurrencyContainer, AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field90F	*/
	@Override
	...
	*/
	public static Field90F get(final SwiftTagListBlock block) {
		...
		return (Field90F) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field90F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field90F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field90F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field90F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field90F> result = new java.util.ArrayList<Field90F>(arr.length);
			for (final Field f : arr) {
				result.add((Field90F) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
