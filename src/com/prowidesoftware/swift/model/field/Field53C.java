...
public class Field53C extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field53C	*/
	@Override
	...
	*/
	public static Field53C get(final SwiftTagListBlock block) {
		...
		return (Field53C) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field53C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field53C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field53C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field53C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field53C> result = new java.util.ArrayList<Field53C>(arr.length);
			for (final Field f : arr) {
				result.add((Field53C) f);
			}
			return result;
		}
