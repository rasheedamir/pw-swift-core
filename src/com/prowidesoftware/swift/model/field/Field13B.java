 ...
 * Field 13B<br /><br />
 *
 * validation pattern: :4!c/[8c]/30x<br />
...
public class Field13B extends Field implements Serializable , GenericField {
	...
	*/
	 ...
	 */
	public Field13B setComponent1(String component1) {
	 ...
	 */
	public Field13B setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field13B setComponent2(String component2) {
	 ...
	 */
	public Field13B setDataSourceScheme(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field13B setComponent3(String component3) {
	 ...
	 */
	public Field13B setNumber(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field13B	*/
	@Override
	...
	*/
	public static Field13B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field13B) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field13B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field13B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field13B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field13B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field13B> result = new java.util.ArrayList<Field13B>(arr.length);
			for (final Field f : arr) {
				result.add((Field13B) f);
			}
			return result;
		}
