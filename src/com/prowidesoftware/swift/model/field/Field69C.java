 ...
 * Field 69C<br /><br />
 *
 * validation pattern: :4!c//&lt;DATE4&gt;/4!c<br />
 * parser pattern: :S//S/S<br />
 * components pattern: SDS<br />
 *
...
public class Field69C extends Field implements Serializable , DateContainer, GenericField {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 69C
	 */
    public static final String NAME = "69C";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_69C = "69C";
	public static final String PARSER_PATTERN =":S//S/S";
	public static final String COMPONENTS_PATTERN = "SDS";
	...
	*/
	 ...
	 */
	public Field69C setComponent1(String component1) {
	 ...
	 */
	public Field69C setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field69C setComponent2(String component2) {
	 ...
	 */
	public Field69C setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field69C setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field69C setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate4(component2));
		return this;
	}
	 ...
	 */
	public Field69C setComponent3(String component3) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field69C	*/
	@Override
	...
	*/
	public static Field69C get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field69C) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field69C get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field69C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field69C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field69C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field69C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field69C> result = new java.util.ArrayList<Field69C>(arr.length);
			for (final Field f : arr) {
				result.add((Field69C) f);
			}
			return result;
		}
