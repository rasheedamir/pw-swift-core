 ...
 * Field 99A<br /><br />
 *
 * validation pattern: :4!c//[N]3!n<br />
...
public class Field99A extends Field implements Serializable , GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field99A	*/
	@Override
	...
	*/
	public static Field99A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field99A) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field99A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field99A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field99A> result = new java.util.ArrayList<Field99A>(arr.length);
			for (final Field f : arr) {
				result.add((Field99A) f);
			}
			return result;
		}
