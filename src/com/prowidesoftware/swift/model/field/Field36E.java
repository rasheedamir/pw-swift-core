 ...
 * Field 36E<br /><br />
 *
 * validation pattern: :4!c//4!c/[N]&lt;AMOUNT&gt;15<br />
 * parser pattern: :S//S/[c]N<br />
 * components pattern: SSSN<br />
 *
...
public class Field36E extends Field implements Serializable , AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field36E	*/
	@Override
	...
	*/
	public static Field36E get(final SwiftTagListBlock block) {
		...
		return (Field36E) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field36E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field36E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field36E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field36E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field36E> result = new java.util.ArrayList<Field36E>(arr.length);
			for (final Field f : arr) {
				result.add((Field36E) f);
			}
			return result;
		}
