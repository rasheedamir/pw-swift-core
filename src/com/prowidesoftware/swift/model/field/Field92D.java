 ...
 * Field 92D<br /><br />
 *
 * validation pattern: :4!c//&lt;AMOUNT&gt;15/&lt;AMOUNT&gt;15<br />
 * parser pattern: :S//N/N<br />
 * components pattern: SNN<br />
 *
...
public class Field92D extends Field implements Serializable , AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field92D	*/
	@Override
	...
	*/
	public static Field92D get(final SwiftTagListBlock block) {
		...
		return (Field92D) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field92D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field92D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field92D> result = new java.util.ArrayList<Field92D>(arr.length);
			for (final Field f : arr) {
				result.add((Field92D) f);
			}
			return result;
		}
