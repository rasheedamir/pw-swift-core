...
public class Field102 extends Field implements Serializable , BICContainer {
	...
	*/
	 ...
	 */
	public Field102 setComponent1(String component1) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field102	*/
	@Override
	...
	*/
	public static Field102 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field102) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field102 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field102 in the given message
	...
	/**
	 * Get a list of all occurrences of the field Field102 from the given block
	 * an empty list is returned if none found.
	 *
