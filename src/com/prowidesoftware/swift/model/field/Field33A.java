...
public class Field33A extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33A	*/
	@Override
	...
	*/
	public static Field33A get(final SwiftTagListBlock block) {
		...
		return (Field33A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field33A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field33A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33A> result = new java.util.ArrayList<Field33A>(arr.length);
			for (final Field f : arr) {
				result.add((Field33A) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
