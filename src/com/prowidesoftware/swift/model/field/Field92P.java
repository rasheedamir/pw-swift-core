...
public class Field92P extends Field implements Serializable , AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field92P	*/
	@Override
	...
	*/
	public static Field92P get(final SwiftTagListBlock block) {
		...
		return (Field92P) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field92P in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field92P> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field92P from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field92P> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field92P> result = new java.util.ArrayList<Field92P>(arr.length);
			for (final Field f : arr) {
				result.add((Field92P) f);
			}
			return result;
		}
