...
public class Field56D extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field56D setComponent1(String component1) {
	 ...
	 */
	public Field56D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field56D setComponent2(String component2) {
	 ...
	 */
	public Field56D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field56D setComponent3(String component3) {
	 ...
	 */
	public Field56D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field56D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field56D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field56D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field56D setNameAndAddress(String value) {
		java.util.List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field56D setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field56D setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	 ...
	 */
	public Field56D setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field56D	*/
	@Override
	...
	*/
	public static Field56D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field56D) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field56D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field56D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field56D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field56D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field56D> result = new java.util.ArrayList<Field56D>(arr.length);
			for (final Field f : arr) {
				result.add((Field56D) f);
			}
			return result;
		}
