...
public class Field35D extends Field implements Serializable , DateContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 35D
	 */
    public static final String NAME = "35D";
    /**
	...
	*/
	 ...
	 */
	public Field35D setComponent1(String component1) {
	 ...
	 */
	public Field35D setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field35D setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field35D setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field35D	*/
	@Override
	...
	*/
	public static Field35D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field35D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field35D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field35D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field35D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field35D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field35D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field35D> result = new java.util.ArrayList<Field35D>(arr.length);
			for (final Field f : arr) {
				result.add((Field35D) f);
			}
			return result;
		}
