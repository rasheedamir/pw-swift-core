 ...
 * Field 92A<br /><br />
 *
 * validation pattern: :4!c//[N]&lt;AMOUNT&gt;15<br />
 * parser pattern: :S//[c]N<br />
...
public class Field92A extends Field implements Serializable , AmountContainer, GenericField {
	...
	*/
	...
	/**
	 * Get the RateAmount (component3).
	 * @return the RateAmount from component3
	 */
	...
	/**
	 * Get the RateAmount (component3) as Number
	 * @return the RateAmount from component3 converted to Number or <code>null</code> if cannot be converted
	 */
	...
	/**
	 * Set the RateAmount (component3).
	 * @param component3 the RateAmount to set
	 */
	...
	/**
	 * Set the RateAmount (component3) as Number
	 * @param component3 Number with the RateAmount content to set
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field92A	*/
	@Override
	...
	*/
	public static Field92A get(final SwiftTagListBlock block) {
		...
		return (Field92A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field92A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field92A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field92A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field92A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field92A> result = new java.util.ArrayList<Field92A>(arr.length);
			for (final Field f : arr) {
				result.add((Field92A) f);
			}
			return result;
		}
