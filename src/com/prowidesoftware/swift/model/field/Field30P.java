...
public class Field30P extends Field implements Serializable , DateContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field30P	*/
	@Override
	...
	*/
	public static Field30P get(final SwiftTagListBlock block) {
		...
		return (Field30P) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field30P in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field30P> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field30P from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field30P> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field30P> result = new java.util.ArrayList<Field30P>(arr.length);
			for (final Field f : arr) {
				result.add((Field30P) f);
			}
			return result;
		}
