...
public class Field32R extends Field implements Serializable , CurrencyContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field32R setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field32R setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field32R setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field32R setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field32R setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32R	*/
	@Override
	...
	*/
	public static Field32R get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32R) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field32R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field32R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32R> result = new java.util.ArrayList<Field32R>(arr.length);
			for (final Field f : arr) {
				result.add((Field32R) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
