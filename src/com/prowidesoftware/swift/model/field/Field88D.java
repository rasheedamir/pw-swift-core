...
public class Field88D extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 88D
	 */
    public static final String NAME = "88D";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_88D = "88D";
	...
	*/
	 ...
	 */
	public Field88D setComponent1(String component1) {
	 ...
	 */
	public Field88D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field88D setComponent2(String component2) {
	 ...
	 */
	public Field88D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field88D setComponent3(String component3) {
	 ...
	 */
	public Field88D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field88D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field88D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field88D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field88D setNameAndAddress(String value) {
		java.util.List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field88D setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field88D setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	 ...
	 */
	public Field88D setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field88D	*/
	@Override
	...
	*/
	public static Field88D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field88D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field88D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field88D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field88D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field88D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field88D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field88D> result = new java.util.ArrayList<Field88D>(arr.length);
			for (final Field f : arr) {
				result.add((Field88D) f);
			}
			return result;
		}
