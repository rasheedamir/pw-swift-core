...
public class Field90K extends Field implements Serializable , AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field90K	*/
	@Override
	...
	*/
	public static Field90K get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field90K) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field90K in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field90K> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field90K from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field90K> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field90K> result = new java.util.ArrayList<Field90K>(arr.length);
			for (final Field f : arr) {
				result.add((Field90K) f);
			}
			return result;
		}
