...
public class Field40E extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field40E	*/
	@Override
	...
	*/
	public static Field40E get(final SwiftTagListBlock block) {
		...
		return (Field40E) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field40E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field40E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field40E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field40E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field40E> result = new java.util.ArrayList<Field40E>(arr.length);
			for (final Field f : arr) {
				result.add((Field40E) f);
			}
			return result;
		}
