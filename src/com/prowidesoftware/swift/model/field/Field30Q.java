...
public class Field30Q extends Field implements Serializable , DateContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 30Q
	 */
    public static final String NAME = "30Q";
    /**
	...
	*/
	 ...
	 */
	public Field30Q setComponent1(String component1) {
	 ...
	 */
	public Field30Q setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field30Q setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field30Q setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate4(component1));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field30Q	*/
	@Override
	...
	*/
	public static Field30Q get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field30Q) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field30Q get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field30Q in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field30Q> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field30Q from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field30Q> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field30Q> result = new java.util.ArrayList<Field30Q>(arr.length);
			for (final Field f : arr) {
				result.add((Field30Q) f);
			}
			return result;
		}
