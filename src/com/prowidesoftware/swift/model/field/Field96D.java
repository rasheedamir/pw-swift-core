...
public class Field96D extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 96D
	 */
    public static final String NAME = "96D";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_96D = "96D";
	...
	*/
	 ...
	 */
	public Field96D setComponent1(String component1) {
	 ...
	 */
	public Field96D setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field96D setComponent2(String component2) {
	 ...
	 */
	public Field96D setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field96D setComponent3(String component3) {
	 ...
	 */
	public Field96D setComponent4(String component4) {
	 ...
	 */
	public Field96D setComponent5(String component5) {
	 ...
	 */
	public Field96D setComponent6(String component6) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field96D	*/
	@Override
	...
	*/
	public static Field96D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field96D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field96D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field96D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field96D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field96D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field96D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field96D> result = new java.util.ArrayList<Field96D>(arr.length);
			for (final Field f : arr) {
				result.add((Field96D) f);
			}
			return result;
		}
