 ...
 * Field 69D<br /><br />
 *
 * validation pattern: :4!c//&lt;DATE4&gt;&lt;TIME2&gt;/4!c<br />
 * parser pattern: :S//&lt;DATE4&gt;&lt;TIME2&gt;/S<br />
 * components pattern: SDTS<br />
 *
...
public class Field69D extends Field implements Serializable , DateContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field69D	*/
	@Override
	...
	*/
	public static Field69D get(final SwiftTagListBlock block) {
		...
		return (Field69D) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field69D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field69D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field69D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field69D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field69D> result = new java.util.ArrayList<Field69D>(arr.length);
			for (final Field f : arr) {
				result.add((Field69D) f);
			}
			return result;
		}
