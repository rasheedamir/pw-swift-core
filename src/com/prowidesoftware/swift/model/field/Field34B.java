...
public class Field34B extends Field implements Serializable , CurrencyContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field34B	*/
	@Override
	...
	*/
	public static Field34B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field34B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field34B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field34B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field34B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field34B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field34B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field34B> result = new java.util.ArrayList<Field34B>(arr.length);
			for (final Field f : arr) {
				result.add((Field34B) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
