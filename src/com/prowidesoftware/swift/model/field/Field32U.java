...
public class Field32U extends Field implements Serializable , CurrencyContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 32U
	 */
    public static final String NAME = "32U";
    /**
	...
	*/
	 ...
	 */
	public Field32U setComponent1(String component1) {
	 ...
	 */
	public Field32U setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field32U setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field32U setCurrency(java.util.Currency component1) {
		setComponent(1, SwiftFormatUtils.getCurrency(component1));
		return this;
	}
	 ...
	 */
	public Field32U setComponent2(String component2) {
	 ...
	 */
	public Field32U setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32U	*/
	@Override
	...
	*/
	public static Field32U get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32U) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field32U get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field32U in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field32U> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field32U from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field32U> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32U> result = new java.util.ArrayList<Field32U>(arr.length);
			for (final Field f : arr) {
				result.add((Field32U) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
