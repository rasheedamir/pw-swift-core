...
public class Field35F extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field35F	*/
	@Override
	...
	*/
	public static Field35F get(final SwiftTagListBlock block) {
		...
		return (Field35F) block.getFieldByName(NAME);
	}
