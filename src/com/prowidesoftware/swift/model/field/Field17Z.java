...
public class Field17Z extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field17Z	*/
	@Override
	...
	*/
	public static Field17Z get(final SwiftTagListBlock block) {
		...
		return (Field17Z) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field17Z in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field17Z> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field17Z from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field17Z> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field17Z> result = new java.util.ArrayList<Field17Z>(arr.length);
			for (final Field f : arr) {
				result.add((Field17Z) f);
			}
			return result;
		}
