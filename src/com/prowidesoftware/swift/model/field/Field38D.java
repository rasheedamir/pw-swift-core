...
public class Field38D extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field38D	*/
	@Override
	...
	*/
	public static Field38D get(final SwiftTagListBlock block) {
		...
		return (Field38D) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field38D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field38D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field38D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field38D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field38D> result = new java.util.ArrayList<Field38D>(arr.length);
			for (final Field f : arr) {
				result.add((Field38D) f);
			}
			return result;
		}
