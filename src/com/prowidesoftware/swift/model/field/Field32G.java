...
public class Field32G extends Field implements Serializable , CurrencyContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32G	*/
	@Override
	...
	*/
	public static Field32G get(final SwiftTagListBlock block) {
		...
		return (Field32G) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field32G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field32G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field32G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field32G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32G> result = new java.util.ArrayList<Field32G>(arr.length);
			for (final Field f : arr) {
				result.add((Field32G) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
