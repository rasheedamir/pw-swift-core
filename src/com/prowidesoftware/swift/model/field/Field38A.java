...
public class Field38A extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 38A
	 */
    public static final String NAME = "38A";
    /**
	...
	*/
	 ...
	 */
	public Field38A setComponent1(String component1) {
	 ...
	 */
	public Field38A setComponent1(java.lang.Number component1) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field38A	*/
	@Override
	...
	*/
	public static Field38A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field38A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field38A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field38A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field38A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field38A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field38A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field38A> result = new java.util.ArrayList<Field38A>(arr.length);
			for (final Field f : arr) {
				result.add((Field38A) f);
			}
			return result;
		}
