...
public class Field136 extends Field implements Serializable  {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 136
	 */
    public static final String NAME = "136";
    /**
	...
	*/
	 ...
	 */
	public Field136 setComponent1(String component1) {
	 ...
	 */
	public Field136 setBroadcastInitiator(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field136 setComponent2(String component2) {
	 ...
	 */
	public Field136 setBroadcastNumber(String component2) {
		setComponent(2, component2);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field136	*/
	@Override
	...
	*/
	public static Field136 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field136) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field136 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field136 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field136> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field136 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field136> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field136> result = new java.util.ArrayList<Field136>(arr.length);
			for (final Field f : arr) {
				result.add((Field136) f);
			}
			return result;
		}
