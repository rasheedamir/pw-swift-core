...
public class Field37H extends Field implements Serializable , AmountContainer {
	...
	*/
	 ...
	 */
	public Field37H setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field37H setRate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field37H setRate(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37H	*/
	@Override
	...
	*/
	public static Field37H get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field37H) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field37H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field37H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37H> result = new java.util.ArrayList<Field37H>(arr.length);
			for (final Field f : arr) {
				result.add((Field37H) f);
			}
			return result;
		}
