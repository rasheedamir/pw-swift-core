...
public class Field425 extends Field implements Serializable  {
	...
	*/
	...
	/**
	 * Get the MIRS (component1).
	 * @return the MIRS from component1
	 */
	...
	/**
	 * Set the MIRS (component1).
	 * @param component1 the MIRS to set
	 */
	public Field425 setMIRS(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field425	*/
	@Override
	...
	*/
	public static Field425 get(final SwiftTagListBlock block) {
		...
		return (Field425) block.getFieldByName(NAME);
	}
