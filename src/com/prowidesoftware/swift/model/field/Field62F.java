...
public class Field62F extends Field implements Serializable , DateContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field62F	*/
	@Override
	...
	*/
	public static Field62F get(final SwiftTagListBlock block) {
		...
		return (Field62F) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field62F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field62F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field62F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field62F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field62F> result = new java.util.ArrayList<Field62F>(arr.length);
			for (final Field f : arr) {
				result.add((Field62F) f);
			}
			return result;
		}
