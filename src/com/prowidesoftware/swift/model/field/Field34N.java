...
public class Field34N extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 34N
	 */
    public static final String NAME = "34N";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_34N = "34N";
	...
	*/
	 ...
	 */
	public Field34N setComponent1(String component1) {
	 ...
	 */
	public Field34N setSign(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field34N setComponent2(String component2) {
	 ...
	 */
	public Field34N setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field34N setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field34N setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate2(component2));
		return this;
	}
	 ...
	 */
	public Field34N setComponent3(String component3) {
	 ...
	 */
	public Field34N setComponent3(java.util.Currency component3) {
	 ...
	 */
	public Field34N setCurrency(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field34N setCurrency(java.util.Currency component3) {
		setComponent(3, SwiftFormatUtils.getCurrency(component3));
		return this;
	}
	 ...
	 */
	public Field34N setComponent4(String component4) {
	 ...
	 */
	public Field34N setComponent4(java.lang.Number component4) {
	 ...
	 */
	public Field34N setAmount(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field34N setAmount(java.lang.Number component4) {
		setComponent(4, SwiftFormatUtils.getNumber(component4));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field34N	*/
	@Override
	...
	*/
	public static Field34N get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field34N) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field34N in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field34N get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field34N in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field34N> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field34N from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field34N> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field34N> result = new java.util.ArrayList<Field34N>(arr.length);
			for (final Field f : arr) {
				result.add((Field34N) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
