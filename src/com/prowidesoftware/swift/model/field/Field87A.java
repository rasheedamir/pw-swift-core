...
public class Field87A extends Field implements Serializable , BICContainer {
	...
	*/
	 ...
	 */
	public Field87A setBIC(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field87A setBIC(com.prowidesoftware.swift.model.BIC component3) {
		setComponent(3, SwiftFormatUtils.getBIC(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field87A	*/
	@Override
	...
	*/
	public static Field87A get(final SwiftTagListBlock block) {
		...
		return (Field87A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field87A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field87A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field87A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field87A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field87A> result = new java.util.ArrayList<Field87A>(arr.length);
			for (final Field f : arr) {
				result.add((Field87A) f);
			}
			return result;
		}
