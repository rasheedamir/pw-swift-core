...
public class Field33R extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 33R
	 */
    public static final String NAME = "33R";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_33R = "33R";
	...
	*/
	 ...
	 */
	public Field33R setComponent1(String component1) {
	 ...
	 */
	public Field33R setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field33R setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field33R setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field33R setComponent2(String component2) {
	 ...
	 */
	public Field33R setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field33R setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field33R setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field33R setComponent3(String component3) {
	 ...
	 */
	public Field33R setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field33R setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field33R setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33R	*/
	@Override
	...
	*/
	public static Field33R get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field33R) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field33R in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field33R get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field33R in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field33R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33R from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33R> result = new java.util.ArrayList<Field33R>(arr.length);
			for (final Field f : arr) {
				result.add((Field33R) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
