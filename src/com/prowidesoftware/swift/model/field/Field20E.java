...
public class Field20E extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field20E setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field20E	*/
	@Override
	...
	*/
	public static Field20E get(final SwiftTagListBlock block) {
		...
		return (Field20E) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field20E in the given message.
	...
	/**
	 * Get a list of all occurrences of the field Field20E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field20E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field20E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field20E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field20E> result = new java.util.ArrayList<Field20E>(arr.length);
			for (final Field f : arr) {
				result.add((Field20E) f);
			}
			return result;
		}
