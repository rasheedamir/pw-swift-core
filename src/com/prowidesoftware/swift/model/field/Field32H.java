 ...
 * Field 32H<br /><br />
 *
 * validation pattern: [N]&lt;CUR&gt;&lt;AMOUNT&gt;15<br />
...
public class Field32H extends Field implements Serializable , CurrencyContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field32H setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field32H setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field32H setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field32H setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32H	*/
	@Override
	...
	*/
	public static Field32H get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32H) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field32H get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field32H in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field32H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field32H from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field32H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32H> result = new java.util.ArrayList<Field32H>(arr.length);
			for (final Field f : arr) {
				result.add((Field32H) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
