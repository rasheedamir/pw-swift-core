...
public class Field37P extends Field implements Serializable , AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37P	*/
	@Override
	...
	*/
	public static Field37P get(final SwiftTagListBlock block) {
		...
		return (Field37P) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field37P> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field37P> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37P> result = new java.util.ArrayList<Field37P>(arr.length);
			for (final Field f : arr) {
				result.add((Field37P) f);
			}
			return result;
		}
