...
public class Field12B extends Field implements Serializable , GenericField {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 12B
	 */
    public static final String NAME = "12B";
    /**
	...
	*/
	 ...
	 */
	public Field12B setComponent1(String component1) {
	 ...
	 */
	public Field12B setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field12B setComponent2(String component2) {
	 ...
	 */
	public Field12B setDataSourceScheme(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 * @return the Instrument Type Code from component3
	 */
	 ...
	 */
	public Field12B setComponent3(String component3) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field12B	*/
	@Override
	...
	*/
	public static Field12B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field12B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field12B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field12B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field12B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field12B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field12B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field12B> result = new java.util.ArrayList<Field12B>(arr.length);
			for (final Field f : arr) {
				result.add((Field12B) f);
			}
			return result;
		}
