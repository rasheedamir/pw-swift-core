...
public class Field85A extends Field implements Serializable , BICContainer {
	...
	*/
	 ...
	 */
	public Field85A setComponent3(com.prowidesoftware.swift.model.BIC component3) {
	 ...
	 */
	public Field85A setBIC(com.prowidesoftware.swift.model.BIC component3) {
		setComponent(3, SwiftFormatUtils.getBIC(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field85A	*/
	@Override
	...
	*/
	public static Field85A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field85A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field85A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field85A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field85A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field85A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field85A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field85A> result = new java.util.ArrayList<Field85A>(arr.length);
			for (final Field f : arr) {
				result.add((Field85A) f);
			}
			return result;
		}
