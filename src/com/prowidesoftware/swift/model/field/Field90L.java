...
public class Field90L extends Field implements Serializable , AmountContainer, GenericField {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 90L
	 */
    public static final String NAME = "90L";
    /**
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field90L	*/
	@Override
	...
	*/
	public static Field90L get(final SwiftTagListBlock block) {
		...
		return (Field90L) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field90L in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field90L> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field90L from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field90L> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field90L> result = new java.util.ArrayList<Field90L>(arr.length);
			for (final Field f : arr) {
				result.add((Field90L) f);
			}
			return result;
		}
