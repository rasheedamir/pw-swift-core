...
public class Field53A extends Field implements Serializable , BICContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 53A
	 */
    public static final String NAME = "53A";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_53A = "53A";
	...
	*/
	 ...
	 */
	public Field53A setComponent1(String component1) {
	 ...
	 */
	public Field53A setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field53A setComponent2(String component2) {
	 ...
	 */
	public Field53A setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field53A setComponent3(String component3) {
	 ...
	 */
	public Field53A setComponent3(com.prowidesoftware.swift.model.BIC component3) {
	 ...
	 */
	public Field53A setBIC(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field53A setBIC(com.prowidesoftware.swift.model.BIC component3) {
		setComponent(3, SwiftFormatUtils.getBIC(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field53A	*/
	@Override
	...
	*/
	public static Field53A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field53A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field53A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field53A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field53A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field53A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field53A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field53A> result = new java.util.ArrayList<Field53A>(arr.length);
			for (final Field f : arr) {
				result.add((Field53A) f);
			}
			return result;
		}
