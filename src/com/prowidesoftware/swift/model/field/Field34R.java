...
public class Field34R extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 34R
	 */
    public static final String NAME = "34R";
    /**
	...
	*/
	 ...
	 */
	public Field34R setComponent1(String component1) {
	 ...
	 */
	public Field34R setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field34R setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field34R setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field34R setComponent2(String component2) {
	 ...
	 */
	public Field34R setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field34R setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field34R setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field34R setComponent3(String component3) {
	 ...
	 */
	public Field34R setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field34R setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field34R setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field34R	*/
	@Override
	...
	*/
	public static Field34R get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field34R) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field34R get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field34R in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field34R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field34R from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field34R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field34R> result = new java.util.ArrayList<Field34R>(arr.length);
			for (final Field f : arr) {
				result.add((Field34R) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
