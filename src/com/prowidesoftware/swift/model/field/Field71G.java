...
public class Field71G extends Field implements Serializable , CurrencyContainer, AmountContainer {
	...
	*/
	 ...
	 */
	public Field71G setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field71G setCurrency(java.util.Currency component1) {
		setComponent(1, SwiftFormatUtils.getCurrency(component1));
		return this;
	}
	 ...
	 */
	public Field71G setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field71G setAmount(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field71G	*/
	@Override
	...
	*/
	public static Field71G get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field71G) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field71G get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field71G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field71G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field71G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field71G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field71G> result = new java.util.ArrayList<Field71G>(arr.length);
			for (final Field f : arr) {
				result.add((Field71G) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
