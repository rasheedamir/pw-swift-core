...
public class Field89A extends Field implements Serializable , BICContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field89A	*/
	@Override
	...
	*/
	public static Field89A get(final SwiftTagListBlock block) {
		...
		return (Field89A) block.getFieldByName(NAME);
	}
