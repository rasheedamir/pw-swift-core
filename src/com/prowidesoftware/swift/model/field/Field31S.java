...
public class Field31S extends Field implements Serializable , DateContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field31S	*/
	@Override
	...
	*/
	public static Field31S get(final SwiftTagListBlock block) {
		...
		return (Field31S) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field31S in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field31S> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field31S from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field31S> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field31S> result = new java.util.ArrayList<Field31S>(arr.length);
			for (final Field f : arr) {
				result.add((Field31S) f);
			}
			return result;
		}
