...
public class Field34P extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
    public static final String NAME = "34P";
    /**
	...
	*/
	 ...
	 */
	public Field34P setComponent1(String component1) {
	 ...
	 */
	public Field34P setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field34P setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field34P setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field34P setComponent2(String component2) {
	 ...
	 */
	public Field34P setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field34P setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field34P setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field34P setComponent3(String component3) {
	 ...
	 */
	public Field34P setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field34P setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field34P setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field34P	*/
	@Override
	...
	*/
	public static Field34P get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field34P) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field34P get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field34P in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field34P> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field34P from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field34P> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field34P> result = new java.util.ArrayList<Field34P>(arr.length);
			for (final Field f : arr) {
				result.add((Field34P) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
