...
public class Field95T extends Field implements Serializable , GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field95T	*/
	@Override
	...
	*/
	public static Field95T get(final SwiftTagListBlock block) {
		...
		return (Field95T) block.getFieldByName(NAME);
	}
