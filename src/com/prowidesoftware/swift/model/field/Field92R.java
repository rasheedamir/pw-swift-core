 ...
 * Field 92R<br /><br />
 *
 * validation pattern: :4!c/[8c]/4!c/&lt;AMOUNT&gt;15<br />
...
public class Field92R extends Field implements Serializable , AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field92R	*/
	@Override
	...
	*/
	public static Field92R get(final SwiftTagListBlock block) {
		...
		return (Field92R) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field92R in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field92R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field92R from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field92R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field92R> result = new java.util.ArrayList<Field92R>(arr.length);
			for (final Field f : arr) {
				result.add((Field92R) f);
			}
			return result;
		}
