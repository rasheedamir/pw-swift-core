...
public class Field92F extends Field implements Serializable , CurrencyContainer, AmountContainer, GenericField {
	...
	*/
	 ...
	 */
	public Field92F setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field92F setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field92F setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field92F setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field92F setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field92F	*/
	@Override
	...
	*/
	public static Field92F get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field92F) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field92F get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field92F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field92F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field92F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field92F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field92F> result = new java.util.ArrayList<Field92F>(arr.length);
			for (final Field f : arr) {
				result.add((Field92F) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
