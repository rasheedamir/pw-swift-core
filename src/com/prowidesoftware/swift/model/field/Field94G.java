...
public class Field94G extends Field implements Serializable , GenericField {
	...
	*/
	 ...
	 */
	public Field94G setAddress(String component2) {
		setComponent(2, component2);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field94G	*/
	@Override
	...
	*/
	public static Field94G get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field94G) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field94G get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field94G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field94G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field94G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field94G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field94G> result = new java.util.ArrayList<Field94G>(arr.length);
			for (final Field f : arr) {
				result.add((Field94G) f);
			}
			return result;
		}
