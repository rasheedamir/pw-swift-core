...
public class Field65 extends Field implements Serializable , DateContainer, AmountContainer {
	 ...
	 */
    public static final String NAME = "65";
    /**
	...
	*/
	 ...
	 */
	public Field65 setComponent1(String component1) {
	 ...
	 */
	public Field65 setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field65 setComponent2(String component2) {
	 ...
	 */
	public Field65 setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field65 setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field65 setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate2(component2));
		return this;
	}
	 ...
	 */
	public Field65 setComponent3(String component3) {
	 ...
	 */
	public Field65 setComponent4(String component4) {
	 ...
	 */
	public Field65 setComponent4(java.lang.Number component4) {
	 ...
	 */
	public Field65 setAmount(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field65 setAmount(java.lang.Number component4) {
		setComponent(4, SwiftFormatUtils.getNumber(component4));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field65	*/
	@Override
	...
	*/
	public static Field65 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field65) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field65 get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field65 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field65> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field65 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field65> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field65> result = new java.util.ArrayList<Field65>(arr.length);
			for (final Field f : arr) {
				result.add((Field65) f);
			}
			return result;
		}
