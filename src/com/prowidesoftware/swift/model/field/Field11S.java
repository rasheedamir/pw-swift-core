 ...
 * parser pattern: S$&lt;DATE2&gt;[$S]<br />
 * components pattern: MEN<br />
 *
...
public class Field11S extends Field implements Serializable , DateContainer {
	...
	public static final String PARSER_PATTERN ="S$<DATE2>[$S]";
	...
	*/
	 ...
	 */
	public Field11S setNumber(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field11S setNumber(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field11S	*/
	@Override
	...
	*/
	public static Field11S get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field11S) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field11S get(final SwiftMessage msg) {
