 ...
 * Field 19<br /><br />
 *
 * validation pattern: &lt;AMOUNT&gt;17<br />
 * parser pattern: N<br />
...
public class Field19 extends Field implements Serializable , AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field19	*/
	@Override
	...
	*/
	public static Field19 get(final SwiftTagListBlock block) {
		...
		return (Field19) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field19> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field19> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field19> result = new java.util.ArrayList<Field19>(arr.length);
			for (final Field f : arr) {
				result.add((Field19) f);
			}
			return result;
		}
