...
public class Field32F extends Field implements Serializable , AmountContainer {
	...
	*/
	 ...
	 * @return the Unit from component1
	 */
	 ...
	 */
	public Field32F setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field32F setAmount(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32F	*/
	@Override
	...
	*/
	public static Field32F get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32F) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field32F get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field32F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field32F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field32F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field32F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32F> result = new java.util.ArrayList<Field32F>(arr.length);
			for (final Field f : arr) {
				result.add((Field32F) f);
			}
			return result;
		}
