...
public class Field12A extends Field implements Serializable , GenericField {
	...
	*/
	 ...
	 */
	public Field12A setComponent1(String component1) {
	 ...
	 */
	public Field12A setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field12A setComponent2(String component2) {
	 ...
	 */
	public Field12A setDataSourceScheme(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 * @return the Instrument Code from component3
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field12A	*/
	@Override
	...
	*/
	public static Field12A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field12A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field12A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field12A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field12A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field12A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field12A> result = new java.util.ArrayList<Field12A>(arr.length);
			for (final Field f : arr) {
				result.add((Field12A) f);
			}
			return result;
		}
