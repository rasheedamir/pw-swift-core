...
public class Field53B extends Field implements Serializable  {
	...
	*/
	 ...
	 */
	public Field53B setComponent1(String component1) {
	 ...
	 */
	public Field53B setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field53B setComponent2(String component2) {
	 ...
	 */
	public Field53B setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field53B setComponent3(String component3) {
	 ...
	 */
	public Field53B setLocation(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field53B	*/
	@Override
	...
	*/
	public static Field53B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field53B) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field53B get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field53B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field53B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field53B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field53B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field53B> result = new java.util.ArrayList<Field53B>(arr.length);
			for (final Field f : arr) {
				result.add((Field53B) f);
			}
			return result;
		}
