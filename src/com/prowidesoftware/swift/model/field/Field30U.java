...
public class Field30U extends Field implements Serializable , DateContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field30U	*/
	@Override
	...
	*/
	public static Field30U get(final SwiftTagListBlock block) {
		...
		return (Field30U) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field30U in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field30U> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field30U from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field30U> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field30U> result = new java.util.ArrayList<Field30U>(arr.length);
			for (final Field f : arr) {
				result.add((Field30U) f);
			}
			return result;
		}
