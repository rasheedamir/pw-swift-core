 ...
 * Field 95S<br /><br />
 *
 * validation pattern: :4!c/[8c]/4!c/&lt;CC&gt;/30x<br />
 * parser pattern: :S/[S]/S/S/S<br />
 * components pattern: SSSKS<br />
 *
...
public class Field95S extends Field implements Serializable , GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field95S	*/
	@Override
	...
	*/
	public static Field95S get(final SwiftTagListBlock block) {
		...
		return (Field95S) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field95S> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field95S> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field95S> result = new java.util.ArrayList<Field95S>(arr.length);
			for (final Field f : arr) {
				result.add((Field95S) f);
			}
			return result;
		}
