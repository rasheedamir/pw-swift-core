...
public class Field91A extends Field implements Serializable , BICContainer {
	...
	*/
	 ...
	 */
	public Field91A setComponent1(String component1) {
	 ...
	 */
	public Field91A setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field91A setComponent2(String component2) {
	 ...
	 */
	public Field91A setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field91A setComponent3(String component3) {
	 ...
	 */
	public Field91A setComponent3(com.prowidesoftware.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field91A	*/
	@Override
	...
	*/
	public static Field91A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field91A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field91A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field91A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field91A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field91A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field91A> result = new java.util.ArrayList<Field91A>(arr.length);
			for (final Field f : arr) {
				result.add((Field91A) f);
			}
			return result;
		}
