...
public class Field84A extends Field implements Serializable , BICContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 84A
	 */
    public static final String NAME = "84A";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_84A = "84A";
	...
	*/
	 ...
	 */
	public Field84A setComponent1(String component1) {
	 ...
	 */
	public Field84A setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field84A setComponent2(String component2) {
	 ...
	 */
	public Field84A setAccount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field84A setComponent3(String component3) {
	 ...
	 */
	public Field84A setComponent3(com.prowidesoftware.swift.model.BIC component3) {
	 ...
	 */
	public Field84A setBIC(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field84A setBIC(com.prowidesoftware.swift.model.BIC component3) {
		setComponent(3, SwiftFormatUtils.getBIC(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field84A	*/
	@Override
	...
	*/
	public static Field84A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field84A) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field84A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field84A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field84A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field84A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field84A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field84A> result = new java.util.ArrayList<Field84A>(arr.length);
			for (final Field f : arr) {
				result.add((Field84A) f);
			}
			return result;
		}
