...
public class Field36 extends Field implements Serializable , AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field36	*/
	@Override
	...
	*/
	public static Field36 get(final SwiftTagListBlock block) {
		...
		return (Field36) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field36 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field36> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field36 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field36> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field36> result = new java.util.ArrayList<Field36>(arr.length);
			for (final Field f : arr) {
				result.add((Field36) f);
			}
			return result;
		}
