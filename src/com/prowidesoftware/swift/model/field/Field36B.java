...
public class Field36B extends Field implements Serializable , AmountContainer, GenericField {
	...
	*/
	 ...
	 * @return the Quantity from component3
	 */
	 ...
	 * @return the Quantity from component3 converted to Number or <code>null</code> if cannot be converted
	 */
	 ...
	 */
	public Field36B setComponent3(java.lang.Number component3) {
	...
	/**
	 * Set the Quantity (component3) as Number
	 * @param component3 Number with the Quantity content to set
	 */
	public Field36B setQuantity(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field36B	*/
	@Override
	...
	*/
	public static Field36B get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field36B) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field36B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field36B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field36B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field36B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field36B> result = new java.util.ArrayList<Field36B>(arr.length);
			for (final Field f : arr) {
				result.add((Field36B) f);
			}
			return result;
		}
