...
public class Field99C extends Field implements Serializable , GenericField {
	...
	*/
	 ...
	 */
	public Field99C setNumber(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field99C	*/
	@Override
	...
	*/
	public static Field99C get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field99C) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field99C get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field99C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field99C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field99C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field99C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field99C> result = new java.util.ArrayList<Field99C>(arr.length);
			for (final Field f : arr) {
				result.add((Field99C) f);
			}
			return result;
		}
