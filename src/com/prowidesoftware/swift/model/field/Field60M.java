...
public class Field60M extends Field implements Serializable , DateContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field60M	*/
	@Override
	...
	*/
	public static Field60M get(final SwiftTagListBlock block) {
		...
		return (Field60M) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field60M in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field60M> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field60M from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field60M> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field60M> result = new java.util.ArrayList<Field60M>(arr.length);
			for (final Field f : arr) {
				result.add((Field60M) f);
			}
			return result;
		}
