...
public class Field33E extends Field implements Serializable , CurrencyContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 33E
	 */
    public static final String NAME = "33E";
    /**
	...
	*/
	 ...
	 */
	public Field33E setComponent1(String component1) {
	 ...
	 */
	public Field33E setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field33E setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field33E setCurrency(java.util.Currency component1) {
		setComponent(1, SwiftFormatUtils.getCurrency(component1));
		return this;
	}
	 ...
	 */
	public Field33E setComponent2(String component2) {
	 ...
	 */
	public Field33E setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field33E setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field33E setAmount(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33E	*/
	@Override
	...
	*/
	public static Field33E get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field33E) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field33E get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field33E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field33E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33E> result = new java.util.ArrayList<Field33E>(arr.length);
			for (final Field f : arr) {
				result.add((Field33E) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
