...
public class Field97E extends Field implements Serializable , GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field97E	*/
	@Override
	...
	*/
	public static Field97E get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field97E) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field97E get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field97E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field97E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field97E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field97E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field97E> result = new java.util.ArrayList<Field97E>(arr.length);
			for (final Field f : arr) {
				result.add((Field97E) f);
			}
			return result;
		}
