 ...
 * Field 95R<br /><br />
 *
 * validation pattern: :4!c/8c/34x<br />
...
public class Field95R extends Field implements Serializable , GenericField {
	...
	*/
	 ...
	 */
	public Field95R setComponent1(String component1) {
	 ...
	 */
	public Field95R setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field95R setComponent2(String component2) {
	 ...
	 */
	public Field95R setDataSourceScheme(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field95R setComponent3(String component3) {
	 ...
	 * @param component3 the Proprietary Code to set
	 */
	public Field95R setProprietaryCode(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field95R	*/
	@Override
	...
	*/
	public static Field95R get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field95R) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field95R in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field95R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field95R from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field95R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field95R> result = new java.util.ArrayList<Field95R>(arr.length);
			for (final Field f : arr) {
				result.add((Field95R) f);
			}
			return result;
		}
