...
public class Field37R extends Field implements Serializable , AmountContainer {
	...
	*/
	 ...
	 */
	public Field37R setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field37R setRate(java.lang.Number component2) {
		setComponent(2, SwiftFormatUtils.getNumber(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field37R	*/
	@Override
	...
	*/
	public static Field37R get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field37R) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field37R get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field37R in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field37R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field37R from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field37R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field37R> result = new java.util.ArrayList<Field37R>(arr.length);
			for (final Field f : arr) {
				result.add((Field37R) f);
			}
			return result;
		}
