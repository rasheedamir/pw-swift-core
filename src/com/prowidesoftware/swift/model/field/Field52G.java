...
public class Field52G extends Field implements Serializable , BICContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 52G
	 */
    public static final String NAME = "52G";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_52G = "52G";
	...
	*/
	 ...
	 */
	public Field52G setComponent1(String component1) {
	 ...
	 */
	public Field52G setAccount(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field52G setComponent2(String component2) {
	 ...
	 */
	public Field52G setComponent2(com.prowidesoftware.swift.model.BIC component2) {
	 ...
	 */
	public Field52G setBIC(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field52G setBIC(com.prowidesoftware.swift.model.BIC component2) {
		setComponent(2, SwiftFormatUtils.getBIC(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field52G	*/
	@Override
	...
	*/
	public static Field52G get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field52G) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field52G in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field52G get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field52G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field52G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field52G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field52G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field52G> result = new java.util.ArrayList<Field52G>(arr.length);
			for (final Field f : arr) {
				result.add((Field52G) f);
			}
			return result;
		}
