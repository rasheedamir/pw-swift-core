...
public class Field105 extends Field implements Serializable  {
	...
	*/
	 ...
	 * @return the Delivery Monitoring from component1 converted to Number or <code>null</code> if cannot be converted
	 */
	 ...
	 */
	public Field105 setComponent1(String component1) {
	 ...
	 * @param component1 the Delivery Monitoring to set
	 */
	public Field105 setDeliveryMonitoring(String component1) {
		setComponent(1, component1);
		return this;
	}
	
	/**
	 * Set the Delivery Monitoring (component1) as Number
	 * @param component1 Number with the Delivery Monitoring content to set
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field105	*/
	@Override
	...
	*/
	public static Field105 get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field105) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field105 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field105> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field105 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field105> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field105> result = new java.util.ArrayList<Field105>(arr.length);
			for (final Field f : arr) {
				result.add((Field105) f);
			}
			return result;
		}
