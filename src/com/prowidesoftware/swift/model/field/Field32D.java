...
public class Field32D extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 32D
	 */
    public static final String NAME = "32D";
    /**
	...
	*/
	 ...
	 */
	public Field32D setComponent1(String component1) {
	 ...
	 */
	public Field32D setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field32D setDate(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field32D setDate(java.util.Calendar component1) {
		setComponent(1, SwiftFormatUtils.getDate2(component1));
		return this;
	}
	 ...
	 */
	public Field32D setComponent2(String component2) {
	 ...
	 */
	public Field32D setComponent2(java.util.Currency component2) {
	 ...
	 */
	public Field32D setCurrency(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field32D setCurrency(java.util.Currency component2) {
		setComponent(2, SwiftFormatUtils.getCurrency(component2));
		return this;
	}
	 ...
	 */
	public Field32D setComponent3(String component3) {
	 ...
	 */
	public Field32D setComponent3(java.lang.Number component3) {
	 ...
	 */
	public Field32D setAmount(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field32D setAmount(java.lang.Number component3) {
		setComponent(3, SwiftFormatUtils.getNumber(component3));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field32D	*/
	@Override
	...
	*/
	public static Field32D get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field32D) block.getFieldByName(NAME);
	}
	 ...
	 */
	public static Field32D get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field32D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field32D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field32D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field32D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field32D> result = new java.util.ArrayList<Field32D>(arr.length);
			for (final Field f : arr) {
				result.add((Field32D) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
