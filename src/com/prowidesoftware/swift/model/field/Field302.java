...
public class Field302 extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field302	*/
	@Override
	...
	*/
	public static Field302 get(final SwiftTagListBlock block) {
		...
		return (Field302) block.getFieldByName(NAME);
	}
	 ...
	 */ 
	public static java.util.List<Field302> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	 ...
	 */ 
	public static java.util.List<Field302> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field302> result = new java.util.ArrayList<Field302>(arr.length);
			for (final Field f : arr) {
				result.add((Field302) f);
			}
			return result;
		}
