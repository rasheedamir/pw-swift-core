...
// end qualifiers constants	
	...
	public Field12D getField12D() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("12D");
			if (t == null) {
...
// SliceHeurisitcCodeGenerator [tagnames=[15K], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	...
	/**
	* Get the single occurrence of SequenceK slicing head or tail of the tags with delimiter ${s.getTagNames().get(0)}
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* <em>NOTE: if the tag delimiter is not found this method returns <code>null</code>. </em>
	*/
	@SequenceStyle(Type.GENERATED_SLICE) // SliceHeurisitcCodeGenerator [tagnames=[15K], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	public SequenceK getSequenceK() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final SwiftTagListBlock content = b4.getSubBlockAfterLast("15K", true);
			if (content == null) { 
				return null; 
			} 
...
// BaseSequenceCodeGenerator [seq=K1]
...
// BaseSequenceCodeGenerator [seq=K1a]
	...
	/**
	* Get the list of SequenceK1a delimited by leading tag and end, with an optional tail.
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard. 
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	* @see SwiftTagListBlock#getSubBlocksDelimitedWithOptionalTail(String[], String[], String[])
	*/
...
// BaseSequenceCodeGenerator [seq=K1a1]
	...
	/**
	* Get the list of SequenceK1a1 delimited by leading tag and end, with an optional tail.
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard. 
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	* @see SwiftTagListBlock#getSubBlocksDelimitedWithOptionalTail(String[], String[], String[])
	*/
