...
/**
 * MT 300<br />
 * Foreign Exchange Confirmation<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT300.class.getName());
	 ...
	 * @since 7.6
	 */
	public MT300(final int messageType, final String sender, final String receiver) {
	 ...
	 * 
	 * @return a Field17T object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field17T getField17T() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("17T");
			if (t == null) {
				log.fine("field 17T not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field17U object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field17U getField17U() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("17U");
			if (t == null) {
				log.fine("field 17U not found");
				return null;
			} else {
	...
	public Field17I getField17I() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("17I");
			if (t == null) {
	...
	public Field88J getField88J() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("88J");
			if (t == null) {
	 ...
	 * 
	 * @return a Field81A object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field81A getField81A() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("81A");
			if (t == null) {
				log.fine("field 81A not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field81D object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field81D getField81D() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("81D");
			if (t == null) {
				log.fine("field 81D not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field81J object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field81J getField81J() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("81J");
			if (t == null) {
				log.fine("field 81J not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field89A object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field89A getField89A() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("89A");
			if (t == null) {
				log.fine("field 89A not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field89D object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field89D getField89D() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("89D");
			if (t == null) {
				log.fine("field 89D not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field89J object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field89J getField89J() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("89J");
			if (t == null) {
				log.fine("field 89J not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field22W object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field22W getField22W() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("22W");
			if (t == null) {
				log.fine("field 22W not found");
				return null;
			} else {
	...
	public List<Field17A> getField17A() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("17A");
			final List<Field17A> result = new ArrayList<Field17A>();
			for (int i=0; i<tags.length; i++) {
				result.add(new Field17A(tags[i].getValue()));
			}
			return result;
		}
	}
...
// BaseSequenceCodeGenerator [seq=A]
	public static class SequenceA extends SwiftTagListBlock {
		...
		*/
		public static final String[] TAIL = new String[]{ "83A", "83D", "83J", "77H", "77D", "14C"   };
...
// BaseSequenceCodeGenerator [seq=B]
	public static class SequenceB extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* Last mandatory tagname of the sequence: <em>"36"  </em>
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] END = { "36"   };
		/**
		* List of optional tags after the last mandatory tag
		*/
...
// BaseSequenceCodeGenerator [seq=B2]
	...
	*/ 
	...
	public SequenceB2 getSequenceB2() {
		...
		final SwiftBlock4 b4 = getSwiftMessage().getBlock4();
		if (b4 != null && !b4.isEmpty()) {
			final SwiftTagListBlock content = b4.getSubBlockDelimitedWithOptionalTail(SequenceB2.START, SequenceB2.END, SequenceB2.TAIL);
			if (log.isLoggable(java.util.logging.Level.FINE)) {
				if (content == null) {
...
// BaseSequenceCodeGenerator [seq=D1]
	public static class SequenceD1 extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* First mandatory tagname of the sequence: <em>"17A"  </em>.
		* Array format is for cases when more than one letter options is allowed
		*/
		...
		* List of optional tags after the last mandatory tag
		*/
		public static final String[] TAIL = new String[]{ "53A", "53D", "53J", "56A", "56D", "56J", "57A", "57D", "57J", "58A", "58D", "58J"   };
	...
	*/
	...
	public List<SequenceD1> getSequenceD1List() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final List<SwiftTagListBlock> bs = b4.getSubBlocksDelimitedWithOptionalTail(SequenceD1.START, SequenceD1.END, SequenceD1.TAIL); 
...
// SliceHeurisitcCodeGenerator [tagnames=[15E], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	...
	/**
	* Get the single occurrence of SequenceE slicing head or tail of the tags with delimiter ${s.getTagNames().get(0)}
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* <em>NOTE: if the tag delimiter is not found this method returns <code>null</code>. </em>
	*/
	@SequenceStyle(Type.GENERATED_SLICE) // SliceHeurisitcCodeGenerator [tagnames=[15E], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	public SequenceE getSequenceE() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final SwiftTagListBlock content = b4.getSubBlockAfterLast("15E", true);
			if (content == null) { 
				return null; 
			} 
...
// BaseSequenceCodeGenerator [seq=E1a]
	...
	*/
	...
	public List<SequenceE1a> getSequenceE1aList() {
		...
		final SwiftBlock4 b4 = getSwiftMessage().getBlock4();
		if (b4 != null && !b4.isEmpty()) {
			final List<SequenceE1a> result = new ArrayList<SequenceE1a>();
			final List<SwiftTagListBlock> bs = b4.getSubBlocksDelimitedWithOptionalTail(SequenceE1a.START, SequenceE1a.END, SequenceE1a.TAIL); 
			if (bs != null && !bs.isEmpty()) {
				for (final SwiftTagListBlock s : bs) {
...
// BaseSequenceCodeGenerator [seq=E1a1]
	...
	*/
	...
	public List<SequenceE1a1> getSequenceE1a1List() {
		...
		final SwiftBlock4 b4 = getSwiftMessage().getBlock4();
		if (b4 != null && !b4.isEmpty()) {
			final List<SequenceE1a1> result = new ArrayList<SequenceE1a1>();
			final List<SwiftTagListBlock> bs = b4.getSubBlocksDelimitedWithOptionalTail(SequenceE1a1.START, SequenceE1a1.END, SequenceE1a1.TAIL); 
			if (bs != null && !bs.isEmpty()) {
				for (final SwiftTagListBlock s : bs) {
