...
/**
 * MT 330<br />
 * Call/Notice Loan/Deposit Confirmation<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
...
// end qualifiers constants	
	 ...
	 * @since 7.6
	 */
	public MT330(final int messageType, final String sender, final String receiver) {
...
// SliceHeurisitcCodeGenerator [tagnames=[15H], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	...
	/**
	* Get the single occurrence of SequenceH slicing head or tail of the tags with delimiter ${s.getTagNames().get(0)}
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* <em>NOTE: if the tag delimiter is not found this method returns <code>null</code>. </em>
	*/
	@SequenceStyle(Type.GENERATED_SLICE) // SliceHeurisitcCodeGenerator [tagnames=[15H], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	public SequenceH getSequenceH() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final SwiftTagListBlock content = b4.getSubBlockAfterLast("15H", true);
			if (content == null) { 
				return null; 
			} 
