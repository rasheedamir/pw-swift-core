...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT380.class.getName());
	...
	public Field19B getField19B() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("19B");
			if (t == null) {
	...
	public Field95P getField95P() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("95P");
			if (t == null) {
	...
	public Field95Q getField95Q() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("95Q");
			if (t == null) {
	...
	public Field95R getField95R() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("95R");
			if (t == null) {
	...
	public Field24B getField24B() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("24B");
			if (t == null) {
	...
	public Field70D getField70D() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("70D");
			if (t == null) {
	...
	public Field22F getField22F() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("22F");
			if (t == null) {
				log.fine("field 22F not found");
				return null;
			} else {
