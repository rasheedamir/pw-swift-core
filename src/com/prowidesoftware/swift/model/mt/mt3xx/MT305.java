...
// begin qualifiers constants	
	...
	*/
	...
	/**
	* Constant for qualifier with value AMEND 
	*/
	...
	*/
	...
	/**
	* Constant for qualifier with value CLOSEOUT 
	*/
	...
	*/
	...
	/**
	* Constant for qualifier with value NEW 
	*/
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT305.class.getName());
	 ...
	 * @since 7.6
	 */
	public MT305(final int messageType, final String sender, final String receiver) {
...
// BaseSequenceCodeGenerator [seq=A]
	public static class SequenceA extends SwiftTagListBlock {
		...
		*/
		public static final String[] TAIL = new String[]{ "77H", "14C", "72"   };
...
// SliceHeurisitcCodeGenerator [tagnames=[15B], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	...
	*/
	@SequenceStyle(Type.GENERATED_SLICE) // SliceHeurisitcCodeGenerator [tagnames=[15B], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	public SequenceB getSequenceB() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final SwiftTagListBlock content = b4.getSubBlockAfterLast("15B", true);
			if (content == null) { 
				return null; 
			} 
	...
	*/
	...
	public List<SequenceB1a> getSequenceB1aList() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final List<SwiftTagListBlock> bs = b4.getSubBlocksDelimitedWithOptionalTail(SequenceB1a.START, SequenceB1a.END, SequenceB1a.TAIL); 
	...
	*/
	...
	public List<SequenceB1a1> getSequenceB1a1List() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final List<SwiftTagListBlock> bs = b4.getSubBlocksDelimitedWithOptionalTail(SequenceB1a1.START, SequenceB1a1.END, SequenceB1a1.TAIL); 
			if (bs != null && !bs.isEmpty()) {
				for (final SwiftTagListBlock s : bs) {
