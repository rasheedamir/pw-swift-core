 ...
 */
public class MT399 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "399";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT399.class.getName());

	/**
	 * Creates an MT399 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT399 content
	 */
	public MT399(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT399 content
	 */
	public MT399(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT399 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT399 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT399(final int messageType, final String sender, final String receiver) {
		super(399, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT399 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT399 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT399 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
