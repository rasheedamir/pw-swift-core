...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT742.class.getName());

	/**
	 * Creates an MT742 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT742 content
	 */
	public MT742(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT742(final int messageType, final String sender, final String receiver) {
