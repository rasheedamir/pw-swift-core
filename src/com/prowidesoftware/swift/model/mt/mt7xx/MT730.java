 ...
 */
public class MT730 extends AbstractMT implements Serializable {
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT730.class.getName());

	/**
	 * Creates an MT730 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT730 content
	 */
	...
	/**
	 * Creates and initializes a new MT730 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT730 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT730(final int messageType, final String sender, final String receiver) {
	 ...
	 */
	@Override
	public MT730 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT730 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT730 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
