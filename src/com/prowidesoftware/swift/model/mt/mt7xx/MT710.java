...
/**
 * MT 710<br />
 * Advice of a Third Bank's or a Non-Bank's Documentary Credit<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT710.class.getName());
	...
	public Field51D getField51D() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("51D");
			if (t == null) {
