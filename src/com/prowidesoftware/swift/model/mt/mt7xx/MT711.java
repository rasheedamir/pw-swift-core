 ...
 */
public class MT711 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "711";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT711.class.getName());

	/**
	 * Creates an MT711 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT711 content
	 */
	public MT711(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT711(final int messageType, final String sender, final String receiver) {
		super(711, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT711 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT711 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT711 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
