...
/**
 * MT 798_760<br />
 * Notification of Guarantee / Standby LC Details<br />
 ...
 */
public class MT798_760 extends AbstractMT implements Serializable {
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT798_760.class.getName());

	/**
	 * Creates an MT798_760 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT798_760 content
	 */
	...
	/**
	 * Creates an MT798_760 initialized with the parameter MtSwiftMessage
	 * @param m swift message with the MT798_760 content
	 */
	...
	/**
	 * Creates and initializes a new MT798_760 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT798_760 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT798_760(final int messageType, final String sender, final String receiver) {
		super(798760, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT798_760 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_760 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_760 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	 ...
	 * The first occurrence of field 12 at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 77E at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 27A at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 21A at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 27 at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 23 at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 30 at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 40C at MT798_760 is expected to be the only one.
	 * 
	 * @return a Field40C object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field40C getField40C() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("40C");
			if (t == null) {
				log.fine("field 40C not found");
				return null;
			} else {
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 77C at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 72 at MT798_760 is expected to be the only one.
	 * 
	 ...
	 * Multiple occurrences of field 20 at MT798_760 are expected at one sequence or across several sequences.
	 * 
