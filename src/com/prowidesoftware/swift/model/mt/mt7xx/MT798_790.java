...
/**
 * MT 798_790<br />
 * Notification of Settlement of Charges Details<br />
 ...
 */
public class MT798_790 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "798_790";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT798_790.class.getName());

	/**
	 * Creates an MT798_790 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT798_790 content
	 */
	public MT798_790(SwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}

	/**
	 * Creates an MT798_790 initialized with the parameter MtSwiftMessage
	 * @param m swift message with the MT798_790 content
	 */
	public MT798_790(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT798_790 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT798_790 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT798_790(final int messageType, final String sender, final String receiver) {
		super(798790, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT798_790 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_790 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_790 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	 ...
	 * The first occurrence of field 12 at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 77E at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 27A at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 21P at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 21 at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 25 at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 32C at MT798_790 is expected to be the only one.
	 * 
	...
	public Field32C getField32C() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("32C");
			if (t == null) {
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 32D at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 52A at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 52D at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 71B at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 72 at MT798_790 is expected to be the only one.
	 * 
	 ...
	 * Multiple occurrences of field 20 at MT798_790 are expected at one sequence or across several sequences.
	 * 
