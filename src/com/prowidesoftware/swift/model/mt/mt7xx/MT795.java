 ...
 */
public class MT795 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "795";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT795.class.getName());

	/**
	 * Creates an MT795 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT795 content
	 */
	public MT795(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT795(final int messageType, final String sender, final String receiver) {
		super(795, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT795 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT795 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT795 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
