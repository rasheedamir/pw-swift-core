 ...
 */
public class MT750 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "750";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT750.class.getName());

	/**
	 * Creates an MT750 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT750 content
	 */
	public MT750(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT750 content
	 */
	public MT750(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT750 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT750 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT750(final int messageType, final String sender, final String receiver) {
		super(750, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT750 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT750 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT750 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	...
	public Field77J getField77J() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("77J");
			if (t == null) {
