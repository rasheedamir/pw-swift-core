...
/**
 * MT 798_779<br />
 * Notification of claim for payment of Guarantee / Standby Letter of Credit<br />
 ...
 */
public class MT798_779 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "798_779";
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT798_779.class.getName());

	/**
	 * Creates an MT798_779 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT798_779 content
	 */
	public MT798_779(SwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}

	/**
	 * Creates an MT798_779 initialized with the parameter MtSwiftMessage
	 * @param m swift message with the MT798_779 content
	 */
	public MT798_779(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT798_779 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT798_779 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT798_779(final int messageType, final String sender, final String receiver) {
		super(798779, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT798_779 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_779 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_779 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	 ...
	 * The first occurrence of field 12 at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 77E at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 27A at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 21A at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 13E at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 31C at MT798_779 is expected to be the only one.
	 * 
	...
	/**
	 * Iterates through block4 fields and return the first one whose name matches 39D, 
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 39D at MT798_779 is expected to be the only one.
	 * 
	 * @return a Field39D object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field39D getField39D() {
		if (getSwiftMessage() == null) {
			throw new IllegalStateException("SwiftMessage was not initialized");
		}
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("39D");
			if (t == null) {
				log.fine("field 39D not found");
				return null;
			} else {
				return new Field39D(t.getValue());
			}
		}
	}
	
	/**
	 * Iterates through block4 fields and return the first one whose name matches 49J, 
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 49J at MT798_779 is expected to be the only one.
	 * 
	 * @return a Field49J object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field49J getField49J() {
		if (getSwiftMessage() == null) {
			throw new IllegalStateException("SwiftMessage was not initialized");
		}
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("49J");
			if (t == null) {
				log.fine("field 49J not found");
				return null;
			} else {
				return new Field49J(t.getValue());
			}
		}
	}
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 78B at MT798_779 is expected to be the only one.
	 * 
	...
	public Field78B getField78B() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("78B");
			if (t == null) {
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 29B at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 72C at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 23X at MT798_779 is expected to be the only one.
	 * 
	 ...
	 * Multiple occurrences of field 20 at MT798_779 are expected at one sequence or across several sequences.
	 * 
