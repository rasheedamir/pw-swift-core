...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT999.class.getName());

	/**
	 * Creates an MT999 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT999 content
	 */
	 ...
	 * @param m swift message with the MT999 content
	 */
	public MT999(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT999 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT999 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT999(final int messageType, final String sender, final String receiver) {
		super(999, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT999 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT999 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT999 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
