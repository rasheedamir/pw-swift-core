 ...
 */
public class MT985 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "985";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT985.class.getName());

	/**
	 * Creates an MT985 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT985 content
	 */
	public MT985(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT985 content
	 */
	public MT985(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT985 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT985 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT985(final int messageType, final String sender, final String receiver) {
		super(985, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT985 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT985 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT985 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	 ...
	 * 
	 * @return a Field75 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field75 getField75() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("75");
			if (t == null) {
				log.fine("field 75 not found");
				return null;
			} else {
