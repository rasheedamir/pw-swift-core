...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT971.class.getName());

	/**
	 * Creates an MT971 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT971 content
	 */
	...
	/**
	 * Creates and initializes a new MT971 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT971 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT971(final int messageType, final String sender, final String receiver) {
	 ...
	 */
	@Override
	public MT971 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT971 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT971 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	...
	/**
	 * Iterates through block4 fields and return all occurrences of fields whose names matches 62F, 
	 * or <code>Collections.emptyList()</code> if none is found.<br />
	 * Multiple occurrences of field 62F at MT971 are expected at one sequence or across several sequences.
	 * 
	 * @return a List of Field62F objects or <code>Collections.emptyList()</code> if none is not found
	 * @see SwiftTagListBlock#getTagsByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public List<Field62F> getField62F() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("62F");
			final List<Field62F> result = new ArrayList<Field62F>();
			for (int i=0; i<tags.length; i++) {
				result.add(new Field62F(tags[i].getValue()));
			}
			return result;
		}
	}
...
// BaseSequenceCodeGenerator [seq=_0]
	public static class Sequence_0 extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* First mandatory tagname of the sequence: <em>"25"  </em>.
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] START = { "25"   } ;
		/**
		* Last mandatory tagname of the sequence: <em>"62F"  </em>
		* Array format is for cases when more than one letter options is allowed
		*/
