 ...
 */
public class MT998 extends AbstractMT implements Serializable {
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT998.class.getName());

	/**
	 * Creates an MT998 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT998 content
	 */
	 ...
	 * @since 7.6
	 */
	public MT998(final int messageType, final String sender, final String receiver) {
	 ...
	 */
	@Override
	public MT998 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT998 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT998 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
