 ...
 */
public class MT972 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "972";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT972.class.getName());

	/**
	 * Creates an MT972 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT972 content
	 */
	public MT972(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT972(final int messageType, final String sender, final String receiver) {
		super(972, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT972 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT972 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT972 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
