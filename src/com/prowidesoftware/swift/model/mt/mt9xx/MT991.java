 ...
 */
public class MT991 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "991";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT991.class.getName());

	/**
	 * Creates an MT991 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT991 content
	 */
	public MT991(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT991 content
	 */
	public MT991(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT991 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT991 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT991(final int messageType, final String sender, final String receiver) {
		super(991, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT991 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT991 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT991 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
