...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT995.class.getName());

	/**
	 * Creates an MT995 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT995 content
	 */
	public MT995(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT995 content
	 */
	public MT995(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT995 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT995 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT995(final int messageType, final String sender, final String receiver) {
