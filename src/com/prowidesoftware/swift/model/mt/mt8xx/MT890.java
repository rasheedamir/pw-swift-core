 ...
 */
public class MT890 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "890";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT890.class.getName());

	/**
	 * Creates an MT890 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT890 content
	 */
	public MT890(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT890(final int messageType, final String sender, final String receiver) {
		super(890, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT890 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT890 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT890 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
