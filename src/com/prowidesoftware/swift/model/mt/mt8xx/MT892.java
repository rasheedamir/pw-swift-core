 ...
 */
public class MT892 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "892";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT892.class.getName());

	/**
	 * Creates an MT892 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT892 content
	 */
	public MT892(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT892 content
	 */
	public MT892(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT892 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT892 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT892(final int messageType, final String sender, final String receiver) {
		super(892, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT892 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT892 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT892 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
