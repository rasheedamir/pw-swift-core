 ...
 */
public class MT898 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "898";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT898.class.getName());

	/**
	 * Creates an MT898 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT898 content
	 */
	public MT898(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT898 content
	 */
	public MT898(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT898 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT898 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT898(final int messageType, final String sender, final String receiver) {
		super(898, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT898 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT898 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT898 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
