...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT412.class.getName());
	 ...
	 * @since 7.6
	 */
	public MT412(final int messageType, final String sender, final String receiver) {
