...
/**
 * MT 490<br />
 * Advice of Charges, Interest and Other Adjustments<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
 ...
 */
public class MT490 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "490";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT490.class.getName());

	/**
	 * Creates an MT490 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT490 content
	 */
	public MT490(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT490 content
	 */
	public MT490(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT490 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT490 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT490(final int messageType, final String sender, final String receiver) {
		super(490, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT490 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT490 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT490 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
