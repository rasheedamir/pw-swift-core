...
/**
 * MT 422<br />
 * Advice of Fate and Request for Instructions<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT422.class.getName());

	/**
	 * Creates an MT422 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT422 content
	 */
	public MT422(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT422(final int messageType, final String sender, final String receiver) {
...
// BaseSequenceCodeGenerator [seq=_0]
	public static class Sequence_0 extends SwiftTagListBlock {
		...
		*/
		public static final String[] TAIL = new String[]{ "32A", "32B", "32K"   };
