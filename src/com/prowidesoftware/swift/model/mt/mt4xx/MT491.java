...
public class MT491 extends AbstractMT implements Serializable {
	...
	*/
	public static final String NAME = "491";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT491.class.getName());

	/**
	 * Creates an MT491 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT491 content
	 */
	 ...
	 * @param m swift message with the MT491 content
	 */
	public MT491(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT491 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT491 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT491(final int messageType, final String sender, final String receiver) {
		super(491, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT491 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT491 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT491 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
