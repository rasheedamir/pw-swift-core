 ...
 */
public class MT450 extends AbstractMT implements Serializable {
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT450.class.getName());

	/**
	 * Creates an MT450 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT450 content
	 */
	 ...
	 * @since 7.6
	 */
	public MT450(final int messageType, final String sender, final String receiver) {
	 ...
	 */
	@Override
	public MT450 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT450 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT450 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	...
	public List<Field52B> getField52B() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("52B");
...
// BaseSequenceCodeGenerator [seq=_0]
	public static class Sequence_0 extends SwiftTagListBlock {
		...
		*/
		public static final String[] TAIL = new String[]{ "52A", "52B", "52D"   };
