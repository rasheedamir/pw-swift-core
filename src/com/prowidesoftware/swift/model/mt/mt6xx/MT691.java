...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT691.class.getName());
	...
	/**
	 * Creates and initializes a new MT691 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT691 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT691(final int messageType, final String sender, final String receiver) {
	 ...
	 */
	@Override
	public MT691 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT691 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT691 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
