...
// end qualifiers constants	
	...
	/**
	 * Creates and initializes a new MT699 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT699 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT699(final int messageType, final String sender, final String receiver) {
		super(699, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT699 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT699 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT699 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
