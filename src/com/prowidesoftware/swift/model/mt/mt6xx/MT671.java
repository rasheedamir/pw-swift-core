...
/**
 * MT 671<br />
 * Standing Settlement Instruction Update Notification<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
...
// end qualifiers constants	
	...
	/**
	 * Creates and initializes a new MT671 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT671 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT671(final int messageType, final String sender, final String receiver) {
	 ...
	 */
	@Override
	public MT671 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT671 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT671 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
