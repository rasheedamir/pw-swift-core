 ...
 */
public class MT695 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "695";
// begin qualifiers constants	
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT695.class.getName());

	/**
	 * Creates an MT695 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT695 content
	 */
	public MT695(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT695 content
	 */
	public MT695(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT695 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT695 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT695(final int messageType, final String sender, final String receiver) {
		super(695, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT695 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT695 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT695 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
