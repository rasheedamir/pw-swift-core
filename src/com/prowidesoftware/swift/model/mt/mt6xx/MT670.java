...
/**
 * MT 670<br />
 * Standing Settlement Instruction Update Notification Request<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
 ...
 */
public class MT670 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "670";
// begin qualifiers constants	
	...
	*/
	...
	/**
	* Constant for qualifier with value DISPAR 
	*/
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT670.class.getName());

	/**
	 * Creates an MT670 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT670 content
	 */
	public MT670(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT670 content
	 */
	public MT670(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT670 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT670 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT670(final int messageType, final String sender, final String receiver) {
		super(670, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT670 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT670 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT670 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
...
// BaseSequenceCodeGenerator [seq=A2]
	public static class SequenceA2 extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* Value for the qualifier of the 16R / 16S tag that indicates start and end of this sequence <em>DISPAR</em>
		*/
		public static final String START_END_16RS = "DISPAR";
		public static final Tag START_TAG = new Tag(Field16R.NAME, START_END_16RS);
		public static final Tag END_TAG = new Tag(Field16S.NAME, START_END_16RS);
		/**
		* Creates a new instance of this sequence with the given tags inside.
	...
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance
	* of <code>SequenceA2</code> is returned</em>  
	* @see SequenceA2#START_END_16RS
	*/ 
	@SequenceStyle(Type.GENERATED_16RS)
	public SequenceA2 getSequenceA2() {
		return new SequenceA2(this.getSwiftMessage());
	}
 	// Slice debug: com.prowidesoftware.swift.codegen.DelimitedSequenceCodeGenerator
	// Slice debug: $s.isSliceHeuristic()
