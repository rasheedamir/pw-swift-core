...
// begin qualifiers constants	
	...
	*/
	...
	/**
	* Constant for qualifier with value COMU 
	*/
	...
	*/
	...
	/**
	* Constant for qualifier with value PREU 
	*/
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT567.class.getName());
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 19B at MT567 is expected to be the only one.
	 * 
...
// BaseSequenceCodeGenerator [seq=A2a]
	...
	*/
	...
	public List<SequenceA2a> getSequenceA2aList() {
		final List<SwiftTagListBlock> blocks = getSwiftMessage().getBlock4().getSubBlocks(SequenceA2a.START_END_16RS);
		if (blocks != null && !blocks.isEmpty()) {
			final List<SequenceA2a> result = new ArrayList<SequenceA2a>(blocks.size());
			for (final SwiftTagListBlock b:blocks) {
				result.add(new SequenceA2a(b));
			}
			return result; 
		}
		// TODO if is is mandatory issue a warning log
