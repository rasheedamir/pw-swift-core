...
/**
 * MT 518<br />
 * Market-Side Securities Trade Confirmation<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT518.class.getName());

	/**
	 * Creates an MT518 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT518 content
	 */
	public MT518(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT518 content
	 */
	public MT518(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT518 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT518 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT518(final int messageType, final String sender, final String receiver) {
		super(518, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT518 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT518 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT518 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
