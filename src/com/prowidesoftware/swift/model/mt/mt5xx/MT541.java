...
/**
 * MT 541<br />
 * Receive Against Payment Instruction<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
 ...
 */
public class MT541 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "541";
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT541.class.getName());

	/**
	 * Creates an MT541 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT541 content
	 */
	public MT541(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT541(final int messageType, final String sender, final String receiver) {
		super(541, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT541 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT541 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT541 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 12 at MT541 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 94C at MT541 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 94F at MT541 is expected to be the only one.
	 * 
