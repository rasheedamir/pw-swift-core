...
/**
 * MT 515<br />
 * Client Confirmation of Purchase or Sale<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
 ...
 */
public class MT515 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "515";
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT515.class.getName());

	/**
	 * Creates an MT515 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT515 content
	 */
	public MT515(SwiftMessage m) {
		super(m);
	 ...
	 * @since 7.6
	 */
	public MT515(final int messageType, final String sender, final String receiver) {
		super(515, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT515 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT515 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT515 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
