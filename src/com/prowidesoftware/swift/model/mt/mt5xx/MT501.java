...
/**
 * MT 501<br />
 * Confirmation of registration or modification<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT501.class.getName());
	...
	public Field93B getField93B() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("93B");
			if (t == null) {
	...
	public Field70C getField70C() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("70C");
			if (t == null) {
