...
/**
 * MT 519<br />
 * Modification of Client Details<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
 ...
 */
public class MT519 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "519";
// begin qualifiers constants	
	...
	*/
	...
	/**
	* Constant for qualifier with value NEWA 
	*/
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT519.class.getName());

	/**
	 * Creates an MT519 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT519 content
	 */
	public MT519(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT519 content
	 */
	public MT519(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT519 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT519 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT519(final int messageType, final String sender, final String receiver) {
		super(519, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT519 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT519 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT519 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
