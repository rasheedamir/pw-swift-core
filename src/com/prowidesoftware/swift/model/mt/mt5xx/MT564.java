...
// end qualifiers constants	
	...
	public List<Field92P> getField92P() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("92P");
	...
	public List<Field90L> getField90L() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("90L");
	...
	public List<Field92R> getField92R() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("92R");
...
// BaseSequenceCodeGenerator [seq=E1a]
	...
	*/
	...
	public List<SequenceE1a> getSequenceE1aList() {
		final List<SwiftTagListBlock> blocks = getSwiftMessage().getBlock4().getSubBlocks(SequenceE1a.START_END_16RS);
		if (blocks != null && !blocks.isEmpty()) {
			final List<SequenceE1a> result = new ArrayList<SequenceE1a>(blocks.size());
			for (final SwiftTagListBlock b:blocks) {
