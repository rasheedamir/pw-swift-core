 ...
 */
public class MT581 extends AbstractMT implements Serializable {
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT581.class.getName());

	/**
	 * Creates an MT581 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT581 content
	 */
	...
	/**
	 * Creates and initializes a new MT581 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT581 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT581(final int messageType, final String sender, final String receiver) {
	 ...
	 */
	@Override
	public MT581 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT581 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT581 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	...
	/**
	 * Iterates through block4 fields and return the first one whose name matches 35H, 
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 35H at MT581 is expected to be the only one.
	 * 
	 * @return a Field35H object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field35H getField35H() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("35H");
			if (t == null) {
				log.fine("field 35H not found");
				return null;
			} else {
	...
	/**
	 * Iterates through block4 fields and return the first one whose name matches 80C, 
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 80C at MT581 is expected to be the only one.
	 * 
	 * @return a Field80C object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field80C getField80C() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("80C");
			if (t == null) {
				log.fine("field 80C not found");
				return null;
			} else {
