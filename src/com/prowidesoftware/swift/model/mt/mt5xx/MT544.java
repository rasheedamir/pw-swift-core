 ...
 */
public class MT544 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "544";
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT544.class.getName());

	/**
	 * Creates an MT544 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT544 content
	 */
	public MT544(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT544 content
	 */
	public MT544(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT544 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT544 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT544(final int messageType, final String sender, final String receiver) {
		super(544, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT544 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT544 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT544 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 12 at MT544 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 94C at MT544 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 94F at MT544 is expected to be the only one.
	 * 
