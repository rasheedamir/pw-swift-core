...
/**
 * MT 514<br />
 * Trade Allocation Instruction<br />
 * <em>SRU 2014</em><br /> 
 *
 *		 
 ...
 */
public class MT514 extends AbstractMT implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "514";
// begin qualifiers constants	
	...
	*/
	...
	/**
	* Constant for qualifier with value ALLO 
	*/
	...
	*/
	...
	/**
	* Constant for qualifier with value SEBL 
	*/
	...
	*/
	...
	/**
	* Constant for qualifier with value TOAL 
	*/
	...
	*/
	...
	/**
	* Constant for qualifier with value TQBT 
	*/
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT514.class.getName());

	/**
	 * Creates an MT514 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT514 content
	 */
	public MT514(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT514 content
	 */
	public MT514(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT514 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT514 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT514(final int messageType, final String sender, final String receiver) {
		super(514, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT514 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT514 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT514 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
