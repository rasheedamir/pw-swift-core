...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT105.class.getName());
	 ...
	 * @since 7.6
	 */
	public MT105(final int messageType, final String sender, final String receiver) {
	 ...
	 * 
	 * @return a Field77F object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field77F getField77F() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("77F");
			if (t == null) {
				log.fine("field 77F not found");
				return null;
			} else {
