...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT107.class.getName());
...
// SliceHeurisitcCodeGenerator [tagnames=[32B], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	...
	*/
	@SequenceStyle(Type.GENERATED_SLICE) // SliceHeurisitcCodeGenerator [tagnames=[32B], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	public SequenceC getSequenceC() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final SwiftTagListBlock content = b4.getSubBlockAfterLast("32B", true);
			if (content == null) { 
				return null; 
			} 
