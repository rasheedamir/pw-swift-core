...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT102.class.getName());
	...
	public List<Field50F> getField50F() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("50F");
...
// BaseSequenceCodeGenerator [seq=A]
	public static class SequenceA extends SwiftTagListBlock {
		...
		*/
		public static final String[] TAIL = new String[]{ "51A", "50A", "50F", "50K", "52A", "52B", "52C", "26T", "77B", "71A", "36"   };
