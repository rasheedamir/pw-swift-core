 ...
 */
public class MT199 extends AbstractMT implements Serializable {
...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT199.class.getName());

	/**
	 * Creates an MT199 initialized with the parameter SwiftMessage
	 * @param m swift message with the MT199 content
	 */
	public MT199(SwiftMessage m) {
		super(m);
	 ...
	 * @param m swift message with the MT199 content
	 */
	public MT199(MtSwiftMessage m) {
		super(m);
		// TODO issue warning if incorrect message type or illegal argument if different
	}
	
	/**
	 * Creates and initializes a new MT199 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT199 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.6
	 */
	public MT199(final int messageType, final String sender, final String receiver) {
		super(199, sender, receiver);
	}
	 ...
	 */
	@Override
	public MT199 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT199 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT199 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
